 ...
 */var Fz;function Aj(){if(Fz)return vc;Fz=1;var h=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function s(d,x,w){var z=null;if(w!==void 0&&(z=""+w),x.key!==void 0&&(z=""+x.key),"key"in x){w={};for(var T in x)T!=="key"&&(w[T]=x[T])}else w=x;return x=w.ref,{$$typeof:h,type:d,key:z,ref:x!==void 0?x:null,props:w}}return vc.Fragment=r,vc.jsx=s,vc.jsxs=s,vc}var Nz;function qj(){return Nz||(Nz=1,Ab.exports=Aj()),Ab.exports}var M=qj(),qb={exports:{}},Q={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gz;function Hj(){if(Gz)return Q;Gz=1;var h=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),s=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),w=Symbol.for("react.consumer"),z=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),B=Symbol.for("react.lazy"),I=Symbol.for("react.activity"),_=Symbol.iterator;function Z(k){return k===null||typeof k!="object"?null:(k=_&&k[_]||k["@@iterator"],typeof k=="function"?k:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,X={};function ye(k,j,V){this.props=k,this.context=j,this.refs=X,this.updater=V||Y}ye.prototype.isReactComponent={},ye.prototype.setState=function(k,j){if(typeof k!="object"&&typeof k!="function"&&k!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,k,j,"setState")},ye.prototype.forceUpdate=function(k){this.updater.enqueueForceUpdate(this,k,"forceUpdate")};function $(){}$.prototype=ye.prototype;function ce(k,j,V){this.props=k,this.context=j,this.refs=X,this.updater=V||Y}var Se=ce.prototype=new $;Se.constructor=ce,G(Se,ye.prototype),Se.isPureReactComponent=!0;var De=Array.isArray;function Pe(){}var ie={H:null,A:null,T:null,S:null},Ye=Object.prototype.hasOwnProperty;function A1(k,j,V){var R=V.ref;return{$$typeof:h,type:k,key:j,ref:R!==void 0?R:null,props:V}}function O2(k,j){return A1(k.type,j,k.props)}function q1(k){return typeof k=="object"&&k!==null&&k.$$typeof===h}function Qe(k){var j={"=":"=0",":":"=2"};return"$"+k.replace(/[=:]/g,function(V){return j[V]})}var Ct=/\/+/g;function B1(k,j){return typeof k=="object"&&k!==null&&k.key!=null?Qe(""+k.key):j.toString(36)}function b1(k){switch(k.status){case"fulfilled":return k.value;case"rejected":throw k.reason;default:switch(typeof k.status=="string"?k.then(Pe,Pe):(k.status="pending",k.then(function(j){k.status==="pending"&&(k.status="fulfilled",k.value=j)},function(j){k.status==="pending"&&(k.status="rejected",k.reason=j)})),k.status){case"fulfilled":return k.value;case"rejected":throw k.reason}}throw k}function A(k,j,V,R,K){var ee=typeof k;(ee==="undefined"||ee==="boolean")&&(k=null);var re=!1;if(k===null)re=!0;else switch(ee){case"bigint":case"string":case"number":re=!0;break;case"object":switch(k.$$typeof){case h:case r:re=!0;break;case B:return re=k._init,A(re(k._payload),j,V,R,K)}}if(re)return K=K(k),re=R===""?"."+B1(k,0):R,De(K)?(V="",re!=null&&(V=re.replace(Ct,"$&/")+"/"),A(K,j,V,"",function(wa){return wa})):K!=null&&(q1(K)&&(K=O2(K,V+(K.key==null||k&&k.key===K.key?"":(""+K.key).replace(Ct,"$&/")+"/")+re)),j.push(K)),1;re=0;var Ge=R===""?".":R+":";if(De(k))for(var ze=0;ze<k.length;ze++)R=k[ze],ee=Ge+B1(R,ze),re+=A(R,j,V,ee,K);else if(ze=Z(k),typeof ze=="function")for(k=ze.call(k),ze=0;!(R=k.next()).done;)R=R.value,ee=Ge+B1(R,ze++),re+=A(R,j,V,ee,K);else if(ee==="object"){if(typeof k.then=="function")return A(b1(k),j,V,R,K);throw j=String(k),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(k).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return re}function D(k,j,V){if(k==null)return k;var R=[],K=0;return A(k,R,"","",function(ee){return j.call(V,ee,K++)}),R}function P(k){if(k._status===-1){var j=k._result;j=j(),j.then(function(V){(k._status===0||k._status===-1)&&(k._status=1,k._result=V)},function(V){(k._status===0||k._status===-1)&&(k._status=2,k._result=V)}),k._status===-1&&(k._status=0,k._result=j)}if(k._status===1)return k._result.default;throw k._result}var ke=typeof reportError=="function"?reportError:function(k){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof k=="object"&&k!==null&&typeof k.message=="string"?String(k.message):String(k),error:k});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",k);return}console.error(k)},me={map:D,forEach:function(k,j,V){D(k,function(){j.apply(this,arguments)},V)},count:function(k){var j=0;return D(k,function(){j++}),j},toArray:function(k){return D(k,function(j){return j})||[]},only:function(k){if(!q1(k))throw Error("React.Children.only expected to receive a single React element child.");return k}};return Q.Activity=I,Q.Children=me,Q.Component=ye,Q.Fragment=s,Q.Profiler=x,Q.PureComponent=ce,Q.StrictMode=d,Q.Suspense=b,Q.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ie,Q.__COMPILER_RUNTIME={__proto__:null,c:function(k){return ie.H.useMemoCache(k)}},Q.cache=function(k){return function(){return k.apply(null,arguments)}},Q.cacheSignal=function(){return null},Q.cloneElement=function(k,j,V){if(k==null)throw Error("The argument must be a React element, but you passed "+k+".");var R=G({},k.props),K=k.key;if(j!=null)for(ee in j.key!==void 0&&(K=""+j.key),j)!Ye.call(j,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&j.ref===void 0||(R[ee]=j[ee]);var ee=arguments.length-2;if(ee===1)R.children=V;else if(1<ee){for(var re=Array(ee),Ge=0;Ge<ee;Ge++)re[Ge]=arguments[Ge+2];R.children=re}return A1(k.type,K,R)},Q.createContext=function(k){return k={$$typeof:z,_currentValue:k,_currentValue2:k,_threadCount:0,Provider:null,Consumer:null},k.Provider=k,k.Consumer={$$typeof:w,_context:k},k},Q.createElement=function(k,j,V){var R,K={},ee=null;if(j!=null)for(R in j.key!==void 0&&(ee=""+j.key),j)Ye.call(j,R)&&R!=="key"&&R!=="__self"&&R!=="__source"&&(K[R]=j[R]);var re=arguments.length-2;if(re===1)K.children=V;else if(1<re){for(var Ge=Array(re),ze=0;ze<re;ze++)Ge[ze]=arguments[ze+2];K.children=Ge}if(k&&k.defaultProps)for(R in re=k.defaultProps,re)K[R]===void 0&&(K[R]=re[R]);return A1(k,ee,K)},Q.createRef=function(){return{current:null}},Q.forwardRef=function(k){return{$$typeof:T,render:k}},Q.isValidElement=q1,Q.lazy=function(k){return{$$typeof:B,_payload:{_status:-1,_result:k},_init:P}},Q.memo=function(k,j){return{$$typeof:v,type:k,compare:j===void 0?null:j}},Q.startTransition=function(k){var j=ie.T,V={};ie.T=V;try{var R=k(),K=ie.S;K!==null&&K(V,R),typeof R=="object"&&R!==null&&typeof R.then=="function"&&R.then(Pe,ke)}catch(ee){ke(ee)}finally{j!==null&&V.types!==null&&(j.types=V.types),ie.T=j}},Q.unstable_useCacheRefresh=function(){return ie.H.useCacheRefresh()},Q.use=function(k){return ie.H.use(k)},Q.useActionState=function(k,j,V){return ie.H.useActionState(k,j,V)},Q.useCallback=function(k,j){return ie.H.useCallback(k,j)},Q.useContext=function(k){return ie.H.useContext(k)},Q.useDebugValue=function(){},Q.useDeferredValue=function(k,j){return ie.H.useDeferredValue(k,j)},Q.useEffect=function(k,j){return ie.H.useEffect(k,j)},Q.useEffectEvent=function(k){return ie.H.useEffectEvent(k)},Q.useId=function(){return ie.H.useId()},Q.useImperativeHandle=function(k,j,V){return ie.H.useImperativeHandle(k,j,V)},Q.useInsertionEffect=function(k,j){return ie.H.useInsertionEffect(k,j)},Q.useLayoutEffect=function(k,j){return ie.H.useLayoutEffect(k,j)},Q.useMemo=function(k,j){return ie.H.useMemo(k,j)},Q.useOptimistic=function(k,j){return ie.H.useOptimistic(k,j)},Q.useReducer=function(k,j,V){return ie.H.useReducer(k,j,V)},Q.useRef=function(k){return ie.H.useRef(k)},Q.useState=function(k){return ie.H.useState(k)},Q.useSyncExternalStore=function(k,j,V){return ie.H.useSyncExternalStore(k,j,V)},Q.useTransition=function(){return ie.H.useTransition()},Q.version="19.2.4",Q}var Xz;function _b(){return Xz||(Xz=1,qb.exports=Hj()),qb.exports}var E=_b();const ba=sA(E),jj=JH({__proto__:null,default:ba},[E]);var Hb={exports:{}},mc={},jb={exports:{}},Ib={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pz;function Ij(){return Pz||(Pz=1,(function(h){function r(A,D){var P=A.length;A.push(D);e:for(;0<P;){var ke=P-1>>>1,me=A[ke];if(0<x(me,D))A[ke]=D,A[P]=me,P=ke;else break e}}function s(A){return A.length===0?null:A[0]}function d(A){if(A.length===0)return null;var D=A[0],P=A.pop();if(P!==D){A[0]=P;e:for(var ke=0,me=A.length,k=me>>>1;ke<k;){var j=2*(ke+1)-1,V=A[j],R=j+1,K=A[R];if(0>x(V,P))R<me&&0>x(K,V)?(A[ke]=K,A[R]=P,ke=R):(A[ke]=V,A[j]=P,ke=j);else if(R<me&&0>x(K,P))A[ke]=K,A[R]=P,ke=R;else break e}}return D}function x(A,D){var P=A.sortIndex-D.sortIndex;return P!==0?P:A.id-D.id}if(h.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var w=performance;h.unstable_now=function(){return w.now()}}else{var z=Date,T=z.now();h.unstable_now=function(){return z.now()-T}}var b=[],v=[],B=1,I=null,_=3,Z=!1,Y=!1,G=!1,X=!1,ye=typeof setTimeout=="function"?setTimeout:null,$=typeof clearTimeout=="function"?clearTimeout:null,ce=typeof setImmediate<"u"?setImmediate:null;function Se(A){for(var D=s(v);D!==null;){if(D.callback===null)d(v);else if(D.startTime<=A)d(v),D.sortIndex=D.expirationTime,r(b,D);else break;D=s(v)}}function De(A){if(G=!1,Se(A),!Y)if(s(b)!==null)Y=!0,Pe||(Pe=!0,Qe());else{var D=s(v);D!==null&&b1(De,D.startTime-A)}}var Pe=!1,ie=-1,Ye=5,A1=-1;function O2(){return X?!0:!(h.unstable_now()-A1<Ye)}function q1(){if(X=!1,Pe){var A=h.unstable_now();A1=A;var D=!0;try{e:{Y=!1,G&&(G=!1,$(ie),ie=-1),Z=!0;var P=_;try{t:{for(Se(A),I=s(b);I!==null&&!(I.expirationTime>A&&O2());){var ke=I.callback;if(typeof ke=="function"){I.callback=null,_=I.priorityLevel;var me=ke(I.expirationTime<=A);if(A=h.unstable_now(),typeof me=="function"){I.callback=me,Se(A),D=!0;break t}I===s(b)&&d(b),Se(A)}else d(b);I=s(b)}if(I!==null)D=!0;else{var k=s(v);k!==null&&b1(De,k.startTime-A),D=!1}}break e}finally{I=null,_=P,Z=!1}D=void 0}}finally{D?Qe():Pe=!1}}}var Qe;if(typeof ce=="function")Qe=function(){ce(q1)};else if(typeof MessageChannel<"u"){var Ct=new MessageChannel,B1=Ct.port2;Ct.port1.onmessage=q1,Qe=function(){B1.postMessage(null)}}else Qe=function(){ye(q1,0)};function b1(A,D){ie=ye(function(){A(h.unstable_now())},D)}h.unstable_IdlePriority=5,h.unstable_ImmediatePriority=1,h.unstable_LowPriority=4,h.unstable_NormalPriority=3,h.unstable_Profiling=null,h.unstable_UserBlockingPriority=2,h.unstable_cancelCallback=function(A){A.callback=null},h.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ye=0<A?Math.floor(1e3/A):5},h.unstable_getCurrentPriorityLevel=function(){return _},h.unstable_next=function(A){switch(_){case 1:case 2:case 3:var D=3;break;default:D=_}var P=_;_=D;try{return A()}finally{_=P}},h.unstable_requestPaint=function(){X=!0},h.unstable_runWithPriority=function(A,D){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var P=_;_=A;try{return D()}finally{_=P}},h.unstable_scheduleCallback=function(A,D,P){var ke=h.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?ke+P:ke):P=ke,A){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=P+me,A={id:B++,callback:D,priorityLevel:A,startTime:P,expirationTime:me,sortIndex:-1},P>ke?(A.sortIndex=P,r(v,A),s(b)===null&&A===s(v)&&(G?($(ie),ie=-1):G=!0,b1(De,P-ke))):(A.sortIndex=me,r(b,A),Y||Z||(Y=!0,Pe||(Pe=!0,Qe()))),A},h.unstable_shouldYield=O2,h.unstable_wrapCallback=function(A){var D=_;return function(){var P=_;_=D;try{return A.apply(this,arguments)}finally{_=P}}}})(Ib)),Ib}var Yz;function Tj(){return Yz||(Yz=1,jb.exports=Ij()),jb.exports}var Tb={exports:{}},Ne={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qz;function Dj(){if(Qz)return Ne;Qz=1;var h=_b();function r(b){var v="https://react.dev/errors/"+b;if(1<arguments.length){v+="?args[]="+encodeURIComponent(arguments[1]);for(var B=2;B<arguments.length;B++)v+="&args[]="+encodeURIComponent(arguments[B])}return"Minified React error #"+b+"; visit "+v+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function s(){}var d={d:{f:s,r:function(){throw Error(r(522))},D:s,C:s,L:s,m:s,X:s,S:s,M:s},p:0,findDOMNode:null},x=Symbol.for("react.portal");function w(b,v,B){var I=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:x,key:I==null?null:""+I,children:b,containerInfo:v,implementation:B}}var z=h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function T(b,v){if(b==="font")return"";if(typeof v=="string")return v==="use-credentials"?v:""}return Ne.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,Ne.createPortal=function(b,v){var B=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!v||v.nodeType!==1&&v.nodeType!==9&&v.nodeType!==11)throw Error(r(299));return w(b,v,null,B)},Ne.flushSync=function(b){var v=z.T,B=d.p;try{if(z.T=null,d.p=2,b)return b()}finally{z.T=v,d.p=B,d.d.f()}},Ne.preconnect=function(b,v){typeof b=="string"&&(v?(v=v.crossOrigin,v=typeof v=="string"?v==="use-credentials"?v:"":void 0):v=null,d.d.C(b,v))},Ne.prefetchDNS=function(b){typeof b=="string"&&d.d.D(b)},Ne.preinit=function(b,v){if(typeof b=="string"&&v&&typeof v.as=="string"){var B=v.as,I=T(B,v.crossOrigin),_=typeof v.integrity=="string"?v.integrity:void 0,Z=typeof v.fetchPriority=="string"?v.fetchPriority:void 0;B==="style"?d.d.S(b,typeof v.precedence=="string"?v.precedence:void 0,{crossOrigin:I,integrity:_,fetchPriority:Z}):B==="script"&&d.d.X(b,{crossOrigin:I,integrity:_,fetchPriority:Z,nonce:typeof v.nonce=="string"?v.nonce:void 0})}},Ne.preinitModule=function(b,v){if(typeof b=="string")if(typeof v=="object"&&v!==null){if(v.as==null||v.as==="script"){var B=T(v.as,v.crossOrigin);d.d.M(b,{crossOrigin:B,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0})}}else v==null&&d.d.M(b)},Ne.preload=function(b,v){if(typeof b=="string"&&typeof v=="object"&&v!==null&&typeof v.as=="string"){var B=v.as,I=T(B,v.crossOrigin);d.d.L(b,B,{crossOrigin:I,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0,type:typeof v.type=="string"?v.type:void 0,fetchPriority:typeof v.fetchPriority=="string"?v.fetchPriority:void 0,referrerPolicy:typeof v.referrerPolicy=="string"?v.referrerPolicy:void 0,imageSrcSet:typeof v.imageSrcSet=="string"?v.imageSrcSet:void 0,imageSizes:typeof v.imageSizes=="string"?v.imageSizes:void 0,media:typeof v.media=="string"?v.media:void 0})}},Ne.preloadModule=function(b,v){if(typeof b=="string")if(v){var B=T(v.as,v.crossOrigin);d.d.m(b,{as:typeof v.as=="string"&&v.as!=="script"?v.as:void 0,crossOrigin:B,integrity:typeof v.integrity=="string"?v.integrity:void 0})}else d.d.m(b)},Ne.requestFormReset=function(b){d.d.r(b)},Ne.unstable_batchedUpdates=function(b,v){return b(v)},Ne.useFormState=function(b,v,B){return z.H.useFormState(b,v,B)},Ne.useFormStatus=function(){return z.H.useHostTransitionStatus()},Ne.version="19.2.4",Ne}var Kz;function pA(){if(Kz)return Tb.exports;Kz=1;function h(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(h)}catch(r){console.error(r)}}return h(),Tb.exports=Dj(),Tb.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jz;function Vj(){if(Jz)return mc;Jz=1;var h=Tj(),r=_b(),s=pA();function d(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function x(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function w(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function z(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function T(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function b(e){if(w(e)!==e)throw Error(d(188))}function v(e){var t=e.alternate;if(!t){if(t=w(e),t===null)throw Error(d(188));return t!==e?null:e}for(var a=e,c=t;;){var n=a.return;if(n===null)break;var i=n.alternate;if(i===null){if(c=n.return,c!==null){a=c;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===a)return b(n),e;if(i===c)return b(n),t;i=i.sibling}throw Error(d(188))}if(a.return!==c.return)a=n,c=i;else{for(var o=!1,y=n.child;y;){if(y===a){o=!0,a=n,c=i;break}if(y===c){o=!0,c=n,a=i;break}y=y.sibling}if(!o){for(y=i.child;y;){if(y===a){o=!0,a=i,c=n;break}if(y===c){o=!0,c=i,a=n;break}y=y.sibling}if(!o)throw Error(d(189))}}if(a.alternate!==c)throw Error(d(190))}if(a.tag!==3)throw Error(d(188));return a.stateNode.current===a?e:t}function B(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=B(e),t!==null)return t;e=e.sibling}return null}var I=Object.assign,_=Symbol.for("react.element"),Z=Symbol.for("react.transitional.element"),Y=Symbol.for("react.portal"),G=Symbol.for("react.fragment"),X=Symbol.for("react.strict_mode"),ye=Symbol.for("react.profiler"),$=Symbol.for("react.consumer"),ce=Symbol.for("react.context"),Se=Symbol.for("react.forward_ref"),De=Symbol.for("react.suspense"),Pe=Symbol.for("react.suspense_list"),ie=Symbol.for("react.memo"),Ye=Symbol.for("react.lazy"),A1=Symbol.for("react.activity"),O2=Symbol.for("react.memo_cache_sentinel"),q1=Symbol.iterator;function Qe(e){return e===null||typeof e!="object"?null:(e=q1&&e[q1]||e["@@iterator"],typeof e=="function"?e:null)}var Ct=Symbol.for("react.client.reference");function B1(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ct?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case G:return"Fragment";case ye:return"Profiler";case X:return"StrictMode";case De:return"Suspense";case Pe:return"SuspenseList";case A1:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case Y:return"Portal";case ce:return e.displayName||"Context";case $:return(e._context.displayName||"Context")+".Consumer";case Se:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case ie:return t=e.displayName||null,t!==null?t:B1(e.type)||"Memo";case Ye:t=e._payload,e=e._init;try{return B1(e(t))}catch{}}return null}var b1=Array.isArray,A=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,D=s.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,P={pending:!1,data:null,method:null,action:null},ke=[],me=-1;function k(e){return{current:e}}function j(e){0>me||(e.current=ke[me],ke[me]=null,me--)}function V(e,t){me++,ke[me]=e.current,e.current=t}var R=k(null),K=k(null),ee=k(null),re=k(null);function Ge(e,t){switch(V(ee,t),V(K,e),V(R,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?rz(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=rz(t),e=sz(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}j(R),V(R,e)}function ze(){j(R),j(K),j(ee)}function wa(e){e.memoizedState!==null&&V(re,e);var t=R.current,a=sz(t,e.type);t!==a&&(V(K,e),V(R,a))}function bc(e){K.current===e&&(j(R),j(K)),re.current===e&&(j(re),pc._currentValue=P)}var dx,Zb;function zt(e){if(dx===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);dx=t&&t[1]||"",Zb=-1<a.stack.indexOf(`
 ...
 *
 * @license MIT
 */function xc(){return xc=Object.assign?Object.assign.bind():function(h){for(var r=1;r<arguments.length;r++){var s=arguments[r];for(var d in s)Object.prototype.hasOwnProperty.call(s,d)&&(h[d]=s[d])}return h},xc.apply(this,arguments)}var _2;(function(h){h.Pop="POP",h.Push="PUSH",h.Replace="REPLACE"})(_2||(_2={}));const $z="popstate";function Uj(h){h===void 0&&(h={});function r(x,w){let{pathname:z="/",search:T="",hash:b=""}=Lc(x.location.hash.substr(1));return!z.startsWith("/")&&!z.startsWith(".")&&(z="/"+z),Vb("",{pathname:z,search:T,hash:b},w.state&&w.state.usr||null,w.state&&w.state.key||"default")}function s(x,w){let z=x.document.querySelector("base"),T="";if(z&&z.getAttribute("href")){let b=x.location.href,v=b.indexOf("#");T=v===-1?b:b.slice(0,v)}return T+"#"+(typeof w=="string"?w:nx(w))}function d(x,w){kA(x.pathname.charAt(0)==="/","relative pathnames are not supported in hash history.push("+JSON.stringify(w)+")")}return Zj(r,s,d,h)}function z1(h,r){if(h===!1||h===null||typeof h>"u")throw new Error(r)}function kA(h,r){if(!h){typeof console<"u"&&console.warn(r);try{throw new Error(r)}catch{}}}function Ej(){return Math.random().toString(36).substr(2,8)}function eA(h,r){return{usr:h.state,key:h.key,idx:r}}function Vb(h,r,s,d){return s===void 0&&(s=null),xc({pathname:typeof h=="string"?h:h.pathname,search:"",hash:""},typeof r=="string"?Lc(r):r,{state:s,key:r&&r.key||d||Ej()})}function nx(h){let{pathname:r="/",search:s="",hash:d=""}=h;return s&&s!=="?"&&(r+=s.charAt(0)==="?"?s:"?"+s),d&&d!=="#"&&(r+=d.charAt(0)==="#"?d:"#"+d),r}function Lc(h){let r={};if(h){let s=h.indexOf("#");s>=0&&(r.hash=h.substr(s),h=h.substr(0,s));let d=h.indexOf("?");d>=0&&(r.search=h.substr(d),h=h.substr(0,d)),h&&(r.pathname=h)}return r}function Zj(h,r,s,d){d===void 0&&(d={});let{window:x=document.defaultView,v5Compat:w=!1}=d,z=x.history,T=_2.Pop,b=null,v=B();v==null&&(v=0,z.replaceState(xc({},z.state,{idx:v}),""));function B(){return(z.state||{idx:null}).idx}function I(){T=_2.Pop;let X=B(),ye=X==null?null:X-v;v=X,b&&b({action:T,location:G.location,delta:ye})}function _(X,ye){T=_2.Push;let $=Vb(G.location,X,ye);s&&s($,X),v=B()+1;let ce=eA($,v),Se=G.createHref($);try{z.pushState(ce,"",Se)}catch(De){if(De instanceof DOMException&&De.name==="DataCloneError")throw De;x.location.assign(Se)}w&&b&&b({action:T,location:G.location,delta:1})}function Z(X,ye){T=_2.Replace;let $=Vb(G.location,X,ye);s&&s($,X),v=B();let ce=eA($,v),Se=G.createHref($);z.replaceState(ce,"",Se),w&&b&&b({action:T,location:G.location,delta:0})}function Y(X){let ye=x.location.origin!=="null"?x.location.origin:x.location.href,$=typeof X=="string"?X:nx(X);return $=$.replace(/ $/,"%20"),z1(ye,"No window.location.(origin|href) available to create URL for href: "+$),new URL($,ye)}let G={get action(){return T},get location(){return h(x,z)},listen(X){if(b)throw new Error("A history only accepts one active listener");return x.addEventListener($z,I),b=X,()=>{x.removeEventListener($z,I),b=null}},createHref(X){return r(x,X)},createURL:Y,encodeLocation(X){let ye=Y(X);return{pathname:ye.pathname,search:ye.search,hash:ye.hash}},push:_,replace:Z,go(X){return z.go(X)}};return G}var tA;(function(h){h.data="data",h.deferred="deferred",h.redirect="redirect",h.error="error"})(tA||(tA={}));function fA(h,r){if(r==="/")return h;if(!h.toLowerCase().startsWith(r.toLowerCase()))return null;let s=r.endsWith("/")?r.length-1:r.length,d=h.charAt(s);return d&&d!=="/"?null:h.slice(s)||"/"}const Fj=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Nj=h=>Fj.test(h);function Gj(h,r){r===void 0&&(r="/");let{pathname:s,search:d="",hash:x=""}=typeof h=="string"?Lc(h):h,w;if(s)if(Nj(s))w=s;else{if(s.includes("//")){let z=s;s=s.replace(/\/\/+/g,"/"),kA(!1,"Pathnames cannot have embedded double slashes - normalizing "+(z+" -> "+s))}s.startsWith("/")?w=aA(s.substring(1),"/"):w=aA(s,r)}else w=r;return{pathname:w,search:Pj(d),hash:Yj(x)}}function aA(h,r){let s=r.replace(/\/+$/,"").split("/");return h.split("/").forEach(x=>{x===".."?s.length>1&&s.pop():x!=="."&&s.push(x)}),s.length>1?s.join("/"):"/"}function Db(h,r,s,d){return"Cannot include a '"+h+"' character in a manually specified "+("`to."+r+"` field ["+JSON.stringify(d)+"].  Please separate it out to the ")+("`to."+s+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Xj(h){return h.filter((r,s)=>s===0||r.route.path&&r.route.path.length>0)}function MA(h,r){let s=Xj(h);return r?s.map((d,x)=>x===s.length-1?d.pathname:d.pathnameBase):s.map(d=>d.pathnameBase)}function vA(h,r,s,d){d===void 0&&(d=!1);let x;typeof h=="string"?x=Lc(h):(x=xc({},h),z1(!x.pathname||!x.pathname.includes("?"),Db("?","pathname","search",x)),z1(!x.pathname||!x.pathname.includes("#"),Db("#","pathname","hash",x)),z1(!x.search||!x.search.includes("#"),Db("#","search","hash",x)));let w=h===""||x.pathname==="",z=w?"/":x.pathname,T;if(z==null)T=s;else{let I=r.length-1;if(!d&&z.startsWith("..")){let _=z.split("/");for(;_[0]==="..";)_.shift(),I-=1;x.pathname=_.join("/")}T=I>=0?r[I]:"/"}let b=Gj(x,T),v=z&&z!=="/"&&z.endsWith("/"),B=(w||z===".")&&s.endsWith("/");return!b.pathname.endsWith("/")&&(v||B)&&(b.pathname+="/"),b}const mA=h=>h.join("/").replace(/\/\/+/g,"/"),Pj=h=>!h||h==="?"?"":h.startsWith("?")?h:"?"+h,Yj=h=>!h||h==="#"?"":h.startsWith("#")?h:"#"+h,gA=["post","put","patch","delete"];new Set(gA);const Qj=["get",...gA];new Set(Qj);/**
 ...
 *
 * @license MIT
 */function ix(){return ix=Object.assign?Object.assign.bind():function(h){for(var r=1;r<arguments.length;r++){var s=arguments[r];for(var d in s)Object.prototype.hasOwnProperty.call(s,d)&&(h[d]=s[d])}return h},ix.apply(this,arguments)}const xA=E.createContext(null),Sa=E.createContext(null),Ob=E.createContext(null),ox=E.createContext({outlet:null,matches:[],isDataRoute:!1});function Kj(h,r){let{relative:s}=r===void 0?{}:r;yx()||z1(!1);let{basename:d,navigator:x}=E.useContext(Sa),{hash:w,pathname:z,search:T}=bA(h,{relative:s}),b=z;return d!=="/"&&(b=z==="/"?d:mA([d,z])),x.createHref({pathname:b,search:T,hash:w})}function yx(){return E.useContext(Ob)!=null}function Rb(){return yx()||z1(!1),E.useContext(Ob).location}function LA(h){E.useContext(Sa).static||E.useLayoutEffect(h)}function Jj(){let{isDataRoute:h}=E.useContext(ox);return h?aI():Wj()}function Wj(){yx()||z1(!1);let h=E.useContext(xA),{basename:r,future:s,navigator:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:w}=Rb(),z=JSON.stringify(MA(x,s.v7_relativeSplatPath)),T=E.useRef(!1);return LA(()=>{T.current=!0}),E.useCallback(function(v,B){if(B===void 0&&(B={}),!T.current)return;if(typeof v=="number"){d.go(v);return}let I=vA(v,JSON.parse(z),w,B.relative==="path");h==null&&r!=="/"&&(I.pathname=I.pathname==="/"?r:mA([r,I.pathname])),(B.replace?d.replace:d.push)(I,B.state,B)},[r,d,z,w,h])}function bA(h,r){let{relative:s}=r===void 0?{}:r,{future:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:w}=Rb(),z=JSON.stringify(MA(x,d.v7_relativeSplatPath));return E.useMemo(()=>vA(h,JSON.parse(z),w,s==="path"),[h,z,w,s])}var SA=(function(h){return h.UseBlocker="useBlocker",h.UseRevalidator="useRevalidator",h.UseNavigateStable="useNavigate",h})(SA||{}),wA=(function(h){return h.UseBlocker="useBlocker",h.UseLoaderData="useLoaderData",h.UseActionData="useActionData",h.UseRouteError="useRouteError",h.UseNavigation="useNavigation",h.UseRouteLoaderData="useRouteLoaderData",h.UseMatches="useMatches",h.UseRevalidator="useRevalidator",h.UseNavigateStable="useNavigate",h.UseRouteId="useRouteId",h})(wA||{});function $j(h){let r=E.useContext(xA);return r||z1(!1),r}function eI(h){let r=E.useContext(ox);return r||z1(!1),r}function tI(h){let r=eI(),s=r.matches[r.matches.length-1];return s.route.id||z1(!1),s.route.id}function aI(){let{router:h}=$j(SA.UseNavigateStable),r=tI(wA.UseNavigateStable),s=E.useRef(!1);return LA(()=>{s.current=!0}),E.useCallback(function(x,w){w===void 0&&(w={}),s.current&&(typeof x=="number"?h.navigate(x):h.navigate(x,ix({fromRouteId:r},w)))},[h,r])}function cI(h,r){h==null||h.v7_startTransition,h==null||h.v7_relativeSplatPath}function lI(h){let{basename:r="/",children:s=null,location:d,navigationType:x=_2.Pop,navigator:w,static:z=!1,future:T}=h;yx()&&z1(!1);let b=r.replace(/^\/*/,"/"),v=E.useMemo(()=>({basename:b,navigator:w,static:z,future:ix({v7_relativeSplatPath:!1},T)}),[b,T,w,z]);typeof d=="string"&&(d=Lc(d));let{pathname:B="/",search:I="",hash:_="",state:Z=null,key:Y="default"}=d,G=E.useMemo(()=>{let X=fA(B,b);return X==null?null:{location:{pathname:X,search:I,hash:_,state:Z,key:Y},navigationType:x}},[b,B,I,_,Z,Y,x]);return G==null?null:E.createElement(Sa.Provider,{value:v},E.createElement(Ob.Provider,{children:s,value:G}))}new Promise(()=>{});/**
 ...
 *
 * @license MIT
 */function Bb(){return Bb=Object.assign?Object.assign.bind():function(h){for(var r=1;r<arguments.length;r++){var s=arguments[r];for(var d in s)Object.prototype.hasOwnProperty.call(s,d)&&(h[d]=s[d])}return h},Bb.apply(this,arguments)}function nI(h,r){if(h==null)return{};var s={},d=Object.keys(h),x,w;for(w=0;w<d.length;w++)x=d[w],!(r.indexOf(x)>=0)&&(s[x]=h[x]);return s}function iI(h){return!!(h.metaKey||h.altKey||h.ctrlKey||h.shiftKey)}function oI(h,r){return h.button===0&&(!r||r==="_self")&&!iI(h)}const yI=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],hI="6";try{window.__reactRouterVersion=hI}catch{}const dI="startTransition",cA=jj[dI];function uI(h){let{basename:r,children:s,future:d,window:x}=h,w=E.useRef();w.current==null&&(w.current=Uj({window:x,v5Compat:!0}));let z=w.current,[T,b]=E.useState({action:z.action,location:z.location}),{v7_startTransition:v}=d||{},B=E.useCallback(I=>{v&&cA?cA(()=>b(I)):b(I)},[b,v]);return E.useLayoutEffect(()=>z.listen(B),[z,B]),E.useEffect(()=>cI(d),[d]),E.createElement(lI,{basename:r,children:s,location:T.location,navigationType:T.action,navigator:z,future:d})}const rI=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",sI=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,pI=E.forwardRef(function(r,s){let{onClick:d,relative:x,reloadDocument:w,replace:z,state:T,target:b,to:v,preventScrollReset:B,viewTransition:I}=r,_=nI(r,yI),{basename:Z}=E.useContext(Sa),Y,G=!1;if(typeof v=="string"&&sI.test(v)&&(Y=v,rI))try{let ce=new URL(window.location.href),Se=v.startsWith("//")?new URL(ce.protocol+v):new URL(v),De=fA(Se.pathname,Z);Se.origin===ce.origin&&De!=null?v=De+Se.search+Se.hash:G=!0}catch{}let X=Kj(v,{relative:x}),ye=kI(v,{replace:z,state:T,target:b,preventScrollReset:B,relative:x,viewTransition:I});function $(ce){d&&d(ce),ce.defaultPrevented||ye(ce)}return E.createElement("a",Bb({},_,{href:Y||X,onClick:G||w?d:$,ref:s,target:b}))});var lA;(function(h){h.UseScrollRestoration="useScrollRestoration",h.UseSubmit="useSubmit",h.UseSubmitFetcher="useSubmitFetcher",h.UseFetcher="useFetcher",h.useViewTransitionState="useViewTransitionState"})(lA||(lA={}));var nA;(function(h){h.UseFetcher="useFetcher",h.UseFetchers="useFetchers",h.UseScrollRestoration="useScrollRestoration"})(nA||(nA={}));function kI(h,r){let{target:s,replace:d,state:x,preventScrollReset:w,relative:z,viewTransition:T}=r===void 0?{}:r,b=Jj(),v=Rb(),B=bA(h,{relative:z});return E.useCallback(I=>{if(oI(I,s)){I.preventDefault();let _=d!==void 0?d:nx(v)===nx(B);b(h,{replace:_,state:x,preventScrollReset:w,relative:z,viewTransition:T})}},[v,b,B,d,x,s,h,w,z,T])}const CA=E.createContext(),fI=({children:h})=>{const[r,s]=E.useState([]),[d,x]=E.useState(!1);E.useEffect(()=>{const I=localStorage.getItem("athena_cart");if(I)try{s(JSON.parse(I))}catch(_){console.error("Failed to parse cart",_)}},[]),E.useEffect(()=>{localStorage.setItem("athena_cart",JSON.stringify(r))},[r]);const w=E.useCallback(I=>{s(_=>_.find(Y=>Y.id===I.id)?_.map(Y=>Y.id===I.id?{...Y,quantity:Y.quantity+1}:Y):[..._,{...I,quantity:1}]),x(!0)},[]),z=E.useCallback((I,_)=>{s(Z=>Z.map(Y=>{if(Y.id===I){const G=Math.max(0,Y.quantity+_);return{...Y,quantity:G}}return Y}).filter(Y=>Y.quantity>0))},[]),T=E.useCallback(()=>s([]),[]),b=E.useMemo(()=>r.reduce((I,_)=>I+_.price*_.quantity,0),[r]),v=E.useMemo(()=>r.reduce((I,_)=>I+_.quantity,0),[r]),B=E.useMemo(()=>({cart:r,addToCart:w,updateQuantity:z,clearCart:T,cartTotal:b,cartCount:v,isCartOpen:d,setIsCartOpen:x}),[r,w,z,T,b,v,d]);return M.jsx(CA.Provider,{value:B,children:h})},MI=()=>{const h=E.useContext(CA);if(!h)throw new Error("useCart must be used within a CartProvider");return h},zA=E.createContext(),hx=()=>E.useContext(zA),vI=({children:h,data:r})=>{const[s,d]=E.useState(r.display_config||{sections:{}});E.useEffect(()=>{r.display_config&&d(r.display_config)},[r.display_config]);const x=(z,T)=>{var v;const b=(v=s.sections)==null?void 0:v[z];return b?!(b.hidden_fields&&b.hidden_fields.includes(T)):!0},w=z=>{var b;const T=(b=s.sections)==null?void 0:b[z];return T?T.visible!==!1:!0};return M.jsx(zA.Provider,{value:{config:s,isFieldVisible:x,isSectionVisible:w},children:h})};function Be({tagName:h="span",value:r,children:s,cmsBind:d,table:x,field:w,id:z,className:T="",style:b={},renderValue:v,...B}){const{isFieldVisible:I}=hx(),_=r!==void 0?r:s,Z=d||{file:x,key:w,index:z||0};if(!I(Z.file,Z.key))return null;const[Y,G]=ba.useState({});ba.useEffect(()=>{},[Z.file,Z.index,Z.key]);const X=v?v(_):typeof _=="object"&&_!==null&&!ba.isValidElement(_)?_.text||_.title||_.label||JSON.stringify(_):_;return M.jsx(h,{className:T,style:{...b,...Y},...B,children:X})}function Ub({src:h,alt:r,className:s,cmsBind:d,dataItem:x={},fallback:w,...z}){const{isFieldVisible:T}=hx(),[b,v]=E.useState(!1);if(d&&!T(d.file,d.key))return null;const B="./",_=h&&(h.endsWith(".svg")||h.endsWith(".ico")||h.includes(".")&&!h.includes("/"))?"":"images/",Z=h&&h!==""&&!h.startsWith("http")&&!h.startsWith("/")&&!h.startsWith("data:")?`${B}${_}${h}`.replace(/\/+/g,"/"):h||null,Y=Z&&(Z.endsWith(".mp4")||Z.endsWith(".webm")||Z.includes("video")),G=`${d==null?void 0:d.key}_loop`,X=x[G]!==!1&&x[G]!=="false";return!Z||b?typeof w=="string"&&w.length<=2?M.jsx("div",{className:"w-full h-full bg-accent flex items-center justify-center text-white font-serif font-black",children:w}):null:Y?M.jsx("video",{src:Z,autoPlay:!0,loop:X,muted:!0,playsInline:!0,className:s,...z}):M.jsx("img",{src:Z,alt:r,className:s,onError:()=>v(!0),...z})}function mI({siteSettings:h={}}){const r=Array.isArray(h)?h[0]||{}:h||{},s=r.site_name||"karel-portfolio-ath",d=(r.logo_text||s).charAt(0).toUpperCase(),x=r.site_logo_image||"athena-icon.svg";return M.jsx("nav",{className:"fixed top-0 left-0 right-0 z-[1000] border-b border-white/5 px-6 py-5 transition-all duration-500 bg-black/80 backdrop-blur-xl",children:M.jsxs("div",{className:"max-w-7xl mx-auto flex justify-between items-center",children:[M.jsxs(pI,{to:"/",className:"flex items-center gap-4 group",children:[M.jsx("div",{className:"relative w-12 h-12 overflow-hidden rounded-full shadow-xl shadow-accent/20 group-hover:scale-105 transition-transform duration-500 bg-accent",children:M.jsx(Ub,{src:x,cmsBind:{file:"site_settings",index:0,key:"site_logo_image"},className:"w-full h-full object-contain",fallback:d})}),M.jsxs("div",{className:"flex flex-col",children:[M.jsx("span",{className:"text-2xl font-serif font-black tracking-tight text-white leading-none mb-1",children:M.jsx(Be,{value:s,cmsBind:{file:"site_settings",index:0,key:"site_name"}})}),r.tagline&&M.jsx("span",{className:"text-[10px] uppercase tracking-[0.3em] text-accent font-bold opacity-80",children:M.jsx(Be,{value:r.tagline,cmsBind:{file:"site_settings",index:0,key:"tagline"}})})]})]}),M.jsx("div",{className:"hidden md:flex items-center gap-8",children:M.jsx("a",{href:"#contact",className:"bg-accent text-white px-6 py-3 rounded-xl font-bold hover:bg-accent/80 transition-colors",children:"Contact"})})]})})}function iA({href:h,value:r,children:s,table:d,field:x,id:w=0,cmsBind:z,className:T="",tagName:b="a",...v}){const{isFieldVisible:B}=hx(),I=z||{file:d,key:x},_=r!==void 0?r:s;return I.file&&!B(I.file,I.key)?null:M.jsx(b,{href:h,className:T,...v,children:_})}const gI=({profile:h})=>M.jsxs("section",{className:"relative pt-32 pb-20 px-6 overflow-hidden",children:[M.jsxs("div",{className:"max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12",children:[M.jsxs("div",{className:"flex-1 text-center md:text-left z-10",children:[M.jsx("h2",{className:"text-blue-500 font-black uppercase tracking-[0.3em] mb-4 text-sm",children:M.jsx(Be,{table:"profile",field:"professional_title",id:0,value:h.professional_title})}),M.jsx("h1",{className:"text-5xl md:text-8xl font-black mb-8 leading-[0.9] tracking-tighter uppercase",children:M.jsx(Be,{table:"profile",field:"full_name",id:0,value:h.full_name})}),M.jsx("p",{className:"text-xl text-zinc-400 mb-10 max-w-xl leading-relaxed",children:M.jsx(Be,{table:"profile",field:"bio_short",id:0,value:h.bio_short})}),M.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 justify-center md:justify-start",children:[M.jsx(iA,{href:"#contact",table:"profile",field:"cta_text",id:0,value:h.cta_text||"Hire Me",className:"bg-white text-black px-10 py-5 rounded-full font-black uppercase text-sm hover:bg-blue-500 hover:text-white transition-all duration-500 flex items-center justify-center"}),M.jsx(iA,{href:"#projects",className:"border border-white/10 px-10 py-5 rounded-full font-black uppercase text-sm hover:bg-white/5 transition-all flex items-center justify-center",children:"View Work"})]})]}),M.jsx("div",{className:"flex-1 relative",children:M.jsxs("div",{className:"relative w-72 h-72 md:w-[500px] md:h-[500px] mx-auto",children:[M.jsx("div",{className:"absolute inset-0 bg-blue-600 blur-[120px] opacity-20 rounded-full animate-pulse"}),M.jsx("div",{className:"relative h-full w-full rounded-full overflow-hidden border border-white/10 group",children:M.jsx(Ub,{src:h.avatar_url,alt:h.full_name,className:"w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700",cmsBind:{file:"profile",index:0,key:"avatar_url"}})})]})})]}),M.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20vw] font-black text-white/[0.02] whitespace-nowrap pointer-events-none select-none",children:"PORTFOLIO"})]}),Eb=({file:h,index:r,isHidden:s})=>null,xI=({projects:h})=>M.jsx("section",{id:"projects",className:"py-32 px-6",children:M.jsxs("div",{className:"max-w-7xl mx-auto",children:[M.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-end mb-20 gap-8",children:[M.jsxs("div",{className:"max-w-2xl",children:[M.jsx("h2",{className:"text-blue-500 font-black uppercase tracking-[0.3em] mb-4 text-sm",children:"Selected Work"}),M.jsxs("h3",{className:"text-5xl md:text-7xl font-black tracking-tighter uppercase leading-[0.9]",children:["Innovation in Every ",M.jsx("span",{className:"text-zinc-800",children:"Pixel"})]})]}),M.jsx("p",{className:"text-zinc-500 max-w-xs text-sm uppercase font-bold tracking-widest leading-loose",children:"Explorations in full-stack development, AI integration, and user-centric design."})]}),M.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10",children:h.map((r,s)=>M.jsxs("div",{className:"group relative",children:[M.jsx(Eb,{file:"projects",index:s,isHidden:r.hidden}),M.jsxs("div",{className:"relative aspect-[16/10] rounded-[40px] overflow-hidden bg-zinc-900 border border-white/5 mb-8",children:[M.jsx(Ub,{src:r.image_url,alt:r.title,className:"w-full h-full object-cover opacity-60 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700",cmsBind:{file:"projects",index:s,key:"image_url"}}),M.jsx("div",{className:"absolute top-6 left-6",children:M.jsx("span",{className:"px-4 py-2 bg-black/50 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest border border-white/10",children:M.jsx(Be,{table:"projects",field:"category",id:s,value:r.category})})})]}),M.jsxs("div",{className:"flex justify-between items-start gap-4",children:[M.jsxs("div",{children:[M.jsx("h4",{className:"text-3xl font-black uppercase tracking-tighter mb-2",children:M.jsx(Be,{table:"projects",field:"title",id:s,value:r.title})}),M.jsx("p",{className:"text-zinc-500 text-sm max-w-sm",children:M.jsx(Be,{table:"projects",field:"summary",id:s,value:r.summary})})]}),M.jsx("button",{className:"w-16 h-16 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all duration-500",children:M.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:M.jsx("path",{d:"M7 17l10-10M7 7h10v10"})})})]})]},s))})]})});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bI=h=>h.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),l=(h,r)=>{const s=E.forwardRef(({color:d="currentColor",size:x=24,strokeWidth:w=2,absoluteStrokeWidth:z,className:T="",children:b,...v},B)=>E.createElement("svg",{ref:B,...LI,width:x,height:x,stroke:d,strokeWidth:z?Number(w)*24/Number(x):w,className:["lucide",`lucide-${bI(h)}`,T].join(" "),...v},[...r.map(([I,_])=>E.createElement(I,_)),...Array.isArray(b)?b:[b]]));return s.displayName=`${h}`,s};/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _y=l("Castle",[["path",{d:"M22 20v-9H2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2Z",key:"109fe4"}],["path",{d:"M18 11V4H6v7",key:"mon5oj"}],["path",{d:"M15 22v-4a3 3 0 0 0-3-3v0a3 3 0 0 0-3 3v4",key:"jdggr9"}],["path",{d:"M22 11V9",key:"3zbp94"}],["path",{d:"M2 11V9",key:"1x5rnq"}],["path",{d:"M6 4V2",key:"1rsq15"}],["path",{d:"M18 4V2",key:"1jsdo1"}],["path",{d:"M10 4V2",key:"75d9ly"}],["path",{d:"M14 4V2",key:"8nj3z6"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oy=l("Cat",[["path",{d:"M12 5c.67 0 1.35.09 2 .26 1.78-2 5.03-2.84 6.42-2.26 1.4.58-.42 7-.42 7 .57 1.07 1 2.24 1 3.44C21 17.9 16.97 21 12 21s-9-3-9-7.56c0-1.25.5-2.4 1-3.44 0 0-1.89-6.42-.5-7 1.39-.58 4.72.23 6.5 2.23A9.04 9.04 0 0 1 12 5Z",key:"x6xyqk"}],["path",{d:"M8 14v.5",key:"1nzgdb"}],["path",{d:"M16 14v.5",key:"1lajdz"}],["path",{d:"M11.25 16.25h1.5L12 17l-.75-.75Z",key:"12kq1m"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _h=l("ClipboardSignature",[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-.5",key:"1but9f"}],["path",{d:"M16 4h2a2 2 0 0 1 1.73 1",key:"1p8n7l"}],["path",{d:"M18.42 9.61a2.1 2.1 0 1 1 2.97 2.97L16.95 17 13 18l.99-3.95 4.43-4.44Z",key:"johvi5"}],["path",{d:"M8 18h1",key:"13wk12"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oh=l("ClipboardType",[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"M9 12v-1h6v1",key:"iehl6m"}],["path",{d:"M11 17h2",key:"12w5me"}],["path",{d:"M12 11v6",key:"1bwqyc"}]]);/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
