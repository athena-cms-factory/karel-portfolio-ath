 ...
 */var Fz;function Aj(){if(Fz)return vc;Fz=1;var y=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function p(d,x,w){var q=null;if(w!==void 0&&(q=""+w),x.key!==void 0&&(q=""+x.key),"key"in x){w={};for(var T in x)T!=="key"&&(w[T]=x[T])}else w=x;return x=w.ref,{$$typeof:y,type:d,key:q,ref:x!==void 0?x:null,props:w}}return vc.Fragment=r,vc.jsx=p,vc.jsxs=p,vc}var Nz;function qj(){return Nz||(Nz=1,Ab.exports=Aj()),Ab.exports}var M=qj(),qb={exports:{}},Y={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gz;function Hj(){if(Gz)return Y;Gz=1;var y=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),p=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),w=Symbol.for("react.consumer"),q=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),S=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),B=Symbol.for("react.lazy"),I=Symbol.for("react.activity"),O=Symbol.iterator;function Q(k){return k===null||typeof k!="object"?null:(k=O&&k[O]||k["@@iterator"],typeof k=="function"?k:null)}var P={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,X={};function ie(k,j,V){this.props=k,this.context=j,this.refs=X,this.updater=V||P}ie.prototype.isReactComponent={},ie.prototype.setState=function(k,j){if(typeof k!="object"&&typeof k!="function"&&k!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,k,j,"setState")},ie.prototype.forceUpdate=function(k){this.updater.enqueueForceUpdate(this,k,"forceUpdate")};function he(){}he.prototype=ie.prototype;function oe(k,j,V){this.props=k,this.context=j,this.refs=X,this.updater=V||P}var Se=oe.prototype=new he;Se.constructor=oe,G(Se,ie.prototype),Se.isPureReactComponent=!0;var _e=Array.isArray;function Pe(){}var le={H:null,A:null,T:null,S:null},Ye=Object.prototype.hasOwnProperty;function A1(k,j,V){var R=V.ref;return{$$typeof:y,type:k,key:j,ref:R!==void 0?R:null,props:V}}function _2(k,j){return A1(k.type,j,k.props)}function q1(k){return typeof k=="object"&&k!==null&&k.$$typeof===y}function Qe(k){var j={"=":"=0",":":"=2"};return"$"+k.replace(/[=:]/g,function(V){return j[V]})}var Ct=/\/+/g;function B1(k,j){return typeof k=="object"&&k!==null&&k.key!=null?Qe(""+k.key):j.toString(36)}function b1(k){switch(k.status){case"fulfilled":return k.value;case"rejected":throw k.reason;default:switch(typeof k.status=="string"?k.then(Pe,Pe):(k.status="pending",k.then(function(j){k.status==="pending"&&(k.status="fulfilled",k.value=j)},function(j){k.status==="pending"&&(k.status="rejected",k.reason=j)})),k.status){case"fulfilled":return k.value;case"rejected":throw k.reason}}throw k}function z(k,j,V,R,K){var $=typeof k;($==="undefined"||$==="boolean")&&(k=null);var re=!1;if(k===null)re=!0;else switch($){case"bigint":case"string":case"number":re=!0;break;case"object":switch(k.$$typeof){case y:case r:re=!0;break;case B:return re=k._init,z(re(k._payload),j,V,R,K)}}if(re)return K=K(k),re=R===""?"."+B1(k,0):R,_e(K)?(V="",re!=null&&(V=re.replace(Ct,"$&/")+"/"),z(K,j,V,"",function(wa){return wa})):K!=null&&(q1(K)&&(K=_2(K,V+(K.key==null||k&&k.key===K.key?"":(""+K.key).replace(Ct,"$&/")+"/")+re)),j.push(K)),1;re=0;var Ge=R===""?".":R+":";if(_e(k))for(var ze=0;ze<k.length;ze++)R=k[ze],$=Ge+B1(R,ze),re+=z(R,j,V,$,K);else if(ze=Q(k),typeof ze=="function")for(k=ze.call(k),ze=0;!(R=k.next()).done;)R=R.value,$=Ge+B1(R,ze++),re+=z(R,j,V,$,K);else if($==="object"){if(typeof k.then=="function")return z(b1(k),j,V,R,K);throw j=String(k),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(k).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return re}function D(k,j,V){if(k==null)return k;var R=[],K=0;return z(k,R,"","",function($){return j.call(V,$,K++)}),R}function N(k){if(k._status===-1){var j=k._result;j=j(),j.then(function(V){(k._status===0||k._status===-1)&&(k._status=1,k._result=V)},function(V){(k._status===0||k._status===-1)&&(k._status=2,k._result=V)}),k._status===-1&&(k._status=0,k._result=j)}if(k._status===1)return k._result.default;throw k._result}var ke=typeof reportError=="function"?reportError:function(k){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof k=="object"&&k!==null&&typeof k.message=="string"?String(k.message):String(k),error:k});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",k);return}console.error(k)},me={map:D,forEach:function(k,j,V){D(k,function(){j.apply(this,arguments)},V)},count:function(k){var j=0;return D(k,function(){j++}),j},toArray:function(k){return D(k,function(j){return j})||[]},only:function(k){if(!q1(k))throw Error("React.Children.only expected to receive a single React element child.");return k}};return Y.Activity=I,Y.Children=me,Y.Component=ie,Y.Fragment=p,Y.Profiler=x,Y.PureComponent=oe,Y.StrictMode=d,Y.Suspense=S,Y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=le,Y.__COMPILER_RUNTIME={__proto__:null,c:function(k){return le.H.useMemoCache(k)}},Y.cache=function(k){return function(){return k.apply(null,arguments)}},Y.cacheSignal=function(){return null},Y.cloneElement=function(k,j,V){if(k==null)throw Error("The argument must be a React element, but you passed "+k+".");var R=G({},k.props),K=k.key;if(j!=null)for($ in j.key!==void 0&&(K=""+j.key),j)!Ye.call(j,$)||$==="key"||$==="__self"||$==="__source"||$==="ref"&&j.ref===void 0||(R[$]=j[$]);var $=arguments.length-2;if($===1)R.children=V;else if(1<$){for(var re=Array($),Ge=0;Ge<$;Ge++)re[Ge]=arguments[Ge+2];R.children=re}return A1(k.type,K,R)},Y.createContext=function(k){return k={$$typeof:q,_currentValue:k,_currentValue2:k,_threadCount:0,Provider:null,Consumer:null},k.Provider=k,k.Consumer={$$typeof:w,_context:k},k},Y.createElement=function(k,j,V){var R,K={},$=null;if(j!=null)for(R in j.key!==void 0&&($=""+j.key),j)Ye.call(j,R)&&R!=="key"&&R!=="__self"&&R!=="__source"&&(K[R]=j[R]);var re=arguments.length-2;if(re===1)K.children=V;else if(1<re){for(var Ge=Array(re),ze=0;ze<re;ze++)Ge[ze]=arguments[ze+2];K.children=Ge}if(k&&k.defaultProps)for(R in re=k.defaultProps,re)K[R]===void 0&&(K[R]=re[R]);return A1(k,$,K)},Y.createRef=function(){return{current:null}},Y.forwardRef=function(k){return{$$typeof:T,render:k}},Y.isValidElement=q1,Y.lazy=function(k){return{$$typeof:B,_payload:{_status:-1,_result:k},_init:N}},Y.memo=function(k,j){return{$$typeof:v,type:k,compare:j===void 0?null:j}},Y.startTransition=function(k){var j=le.T,V={};le.T=V;try{var R=k(),K=le.S;K!==null&&K(V,R),typeof R=="object"&&R!==null&&typeof R.then=="function"&&R.then(Pe,ke)}catch($){ke($)}finally{j!==null&&V.types!==null&&(j.types=V.types),le.T=j}},Y.unstable_useCacheRefresh=function(){return le.H.useCacheRefresh()},Y.use=function(k){return le.H.use(k)},Y.useActionState=function(k,j,V){return le.H.useActionState(k,j,V)},Y.useCallback=function(k,j){return le.H.useCallback(k,j)},Y.useContext=function(k){return le.H.useContext(k)},Y.useDebugValue=function(){},Y.useDeferredValue=function(k,j){return le.H.useDeferredValue(k,j)},Y.useEffect=function(k,j){return le.H.useEffect(k,j)},Y.useEffectEvent=function(k){return le.H.useEffectEvent(k)},Y.useId=function(){return le.H.useId()},Y.useImperativeHandle=function(k,j,V){return le.H.useImperativeHandle(k,j,V)},Y.useInsertionEffect=function(k,j){return le.H.useInsertionEffect(k,j)},Y.useLayoutEffect=function(k,j){return le.H.useLayoutEffect(k,j)},Y.useMemo=function(k,j){return le.H.useMemo(k,j)},Y.useOptimistic=function(k,j){return le.H.useOptimistic(k,j)},Y.useReducer=function(k,j,V){return le.H.useReducer(k,j,V)},Y.useRef=function(k){return le.H.useRef(k)},Y.useState=function(k){return le.H.useState(k)},Y.useSyncExternalStore=function(k,j,V){return le.H.useSyncExternalStore(k,j,V)},Y.useTransition=function(){return le.H.useTransition()},Y.version="19.2.4",Y}var Xz;function Ob(){return Xz||(Xz=1,qb.exports=Hj()),qb.exports}var E=Ob();const ba=sA(E),jj=JH({__proto__:null,default:ba},[E]);var Hb={exports:{}},mc={},jb={exports:{}},Ib={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pz;function Ij(){return Pz||(Pz=1,(function(y){function r(z,D){var N=z.length;z.push(D);e:for(;0<N;){var ke=N-1>>>1,me=z[ke];if(0<x(me,D))z[ke]=D,z[N]=me,N=ke;else break e}}function p(z){return z.length===0?null:z[0]}function d(z){if(z.length===0)return null;var D=z[0],N=z.pop();if(N!==D){z[0]=N;e:for(var ke=0,me=z.length,k=me>>>1;ke<k;){var j=2*(ke+1)-1,V=z[j],R=j+1,K=z[R];if(0>x(V,N))R<me&&0>x(K,V)?(z[ke]=K,z[R]=N,ke=R):(z[ke]=V,z[j]=N,ke=j);else if(R<me&&0>x(K,N))z[ke]=K,z[R]=N,ke=R;else break e}}return D}function x(z,D){var N=z.sortIndex-D.sortIndex;return N!==0?N:z.id-D.id}if(y.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var w=performance;y.unstable_now=function(){return w.now()}}else{var q=Date,T=q.now();y.unstable_now=function(){return q.now()-T}}var S=[],v=[],B=1,I=null,O=3,Q=!1,P=!1,G=!1,X=!1,ie=typeof setTimeout=="function"?setTimeout:null,he=typeof clearTimeout=="function"?clearTimeout:null,oe=typeof setImmediate<"u"?setImmediate:null;function Se(z){for(var D=p(v);D!==null;){if(D.callback===null)d(v);else if(D.startTime<=z)d(v),D.sortIndex=D.expirationTime,r(S,D);else break;D=p(v)}}function _e(z){if(G=!1,Se(z),!P)if(p(S)!==null)P=!0,Pe||(Pe=!0,Qe());else{var D=p(v);D!==null&&b1(_e,D.startTime-z)}}var Pe=!1,le=-1,Ye=5,A1=-1;function _2(){return X?!0:!(y.unstable_now()-A1<Ye)}function q1(){if(X=!1,Pe){var z=y.unstable_now();A1=z;var D=!0;try{e:{P=!1,G&&(G=!1,he(le),le=-1),Q=!0;var N=O;try{t:{for(Se(z),I=p(S);I!==null&&!(I.expirationTime>z&&_2());){var ke=I.callback;if(typeof ke=="function"){I.callback=null,O=I.priorityLevel;var me=ke(I.expirationTime<=z);if(z=y.unstable_now(),typeof me=="function"){I.callback=me,Se(z),D=!0;break t}I===p(S)&&d(S),Se(z)}else d(S);I=p(S)}if(I!==null)D=!0;else{var k=p(v);k!==null&&b1(_e,k.startTime-z),D=!1}}break e}finally{I=null,O=N,Q=!1}D=void 0}}finally{D?Qe():Pe=!1}}}var Qe;if(typeof oe=="function")Qe=function(){oe(q1)};else if(typeof MessageChannel<"u"){var Ct=new MessageChannel,B1=Ct.port2;Ct.port1.onmessage=q1,Qe=function(){B1.postMessage(null)}}else Qe=function(){ie(q1,0)};function b1(z,D){le=ie(function(){z(y.unstable_now())},D)}y.unstable_IdlePriority=5,y.unstable_ImmediatePriority=1,y.unstable_LowPriority=4,y.unstable_NormalPriority=3,y.unstable_Profiling=null,y.unstable_UserBlockingPriority=2,y.unstable_cancelCallback=function(z){z.callback=null},y.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ye=0<z?Math.floor(1e3/z):5},y.unstable_getCurrentPriorityLevel=function(){return O},y.unstable_next=function(z){switch(O){case 1:case 2:case 3:var D=3;break;default:D=O}var N=O;O=D;try{return z()}finally{O=N}},y.unstable_requestPaint=function(){X=!0},y.unstable_runWithPriority=function(z,D){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var N=O;O=z;try{return D()}finally{O=N}},y.unstable_scheduleCallback=function(z,D,N){var ke=y.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?ke+N:ke):N=ke,z){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=N+me,z={id:B++,callback:D,priorityLevel:z,startTime:N,expirationTime:me,sortIndex:-1},N>ke?(z.sortIndex=N,r(v,z),p(S)===null&&z===p(v)&&(G?(he(le),le=-1):G=!0,b1(_e,N-ke))):(z.sortIndex=me,r(S,z),P||Q||(P=!0,Pe||(Pe=!0,Qe()))),z},y.unstable_shouldYield=_2,y.unstable_wrapCallback=function(z){var D=O;return function(){var N=O;O=D;try{return z.apply(this,arguments)}finally{O=N}}}})(Ib)),Ib}var Yz;function Tj(){return Yz||(Yz=1,jb.exports=Ij()),jb.exports}var Tb={exports:{}},Ne={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qz;function Dj(){if(Qz)return Ne;Qz=1;var y=Ob();function r(S){var v="https://react.dev/errors/"+S;if(1<arguments.length){v+="?args[]="+encodeURIComponent(arguments[1]);for(var B=2;B<arguments.length;B++)v+="&args[]="+encodeURIComponent(arguments[B])}return"Minified React error #"+S+"; visit "+v+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function p(){}var d={d:{f:p,r:function(){throw Error(r(522))},D:p,C:p,L:p,m:p,X:p,S:p,M:p},p:0,findDOMNode:null},x=Symbol.for("react.portal");function w(S,v,B){var I=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:x,key:I==null?null:""+I,children:S,containerInfo:v,implementation:B}}var q=y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function T(S,v){if(S==="font")return"";if(typeof v=="string")return v==="use-credentials"?v:""}return Ne.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,Ne.createPortal=function(S,v){var B=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!v||v.nodeType!==1&&v.nodeType!==9&&v.nodeType!==11)throw Error(r(299));return w(S,v,null,B)},Ne.flushSync=function(S){var v=q.T,B=d.p;try{if(q.T=null,d.p=2,S)return S()}finally{q.T=v,d.p=B,d.d.f()}},Ne.preconnect=function(S,v){typeof S=="string"&&(v?(v=v.crossOrigin,v=typeof v=="string"?v==="use-credentials"?v:"":void 0):v=null,d.d.C(S,v))},Ne.prefetchDNS=function(S){typeof S=="string"&&d.d.D(S)},Ne.preinit=function(S,v){if(typeof S=="string"&&v&&typeof v.as=="string"){var B=v.as,I=T(B,v.crossOrigin),O=typeof v.integrity=="string"?v.integrity:void 0,Q=typeof v.fetchPriority=="string"?v.fetchPriority:void 0;B==="style"?d.d.S(S,typeof v.precedence=="string"?v.precedence:void 0,{crossOrigin:I,integrity:O,fetchPriority:Q}):B==="script"&&d.d.X(S,{crossOrigin:I,integrity:O,fetchPriority:Q,nonce:typeof v.nonce=="string"?v.nonce:void 0})}},Ne.preinitModule=function(S,v){if(typeof S=="string")if(typeof v=="object"&&v!==null){if(v.as==null||v.as==="script"){var B=T(v.as,v.crossOrigin);d.d.M(S,{crossOrigin:B,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0})}}else v==null&&d.d.M(S)},Ne.preload=function(S,v){if(typeof S=="string"&&typeof v=="object"&&v!==null&&typeof v.as=="string"){var B=v.as,I=T(B,v.crossOrigin);d.d.L(S,B,{crossOrigin:I,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0,type:typeof v.type=="string"?v.type:void 0,fetchPriority:typeof v.fetchPriority=="string"?v.fetchPriority:void 0,referrerPolicy:typeof v.referrerPolicy=="string"?v.referrerPolicy:void 0,imageSrcSet:typeof v.imageSrcSet=="string"?v.imageSrcSet:void 0,imageSizes:typeof v.imageSizes=="string"?v.imageSizes:void 0,media:typeof v.media=="string"?v.media:void 0})}},Ne.preloadModule=function(S,v){if(typeof S=="string")if(v){var B=T(v.as,v.crossOrigin);d.d.m(S,{as:typeof v.as=="string"&&v.as!=="script"?v.as:void 0,crossOrigin:B,integrity:typeof v.integrity=="string"?v.integrity:void 0})}else d.d.m(S)},Ne.requestFormReset=function(S){d.d.r(S)},Ne.unstable_batchedUpdates=function(S,v){return S(v)},Ne.useFormState=function(S,v,B){return q.H.useFormState(S,v,B)},Ne.useFormStatus=function(){return q.H.useHostTransitionStatus()},Ne.version="19.2.4",Ne}var Kz;function pA(){if(Kz)return Tb.exports;Kz=1;function y(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(y)}catch(r){console.error(r)}}return y(),Tb.exports=Dj(),Tb.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jz;function Vj(){if(Jz)return mc;Jz=1;var y=Tj(),r=Ob(),p=pA();function d(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function x(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function w(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function q(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function T(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function S(e){if(w(e)!==e)throw Error(d(188))}function v(e){var t=e.alternate;if(!t){if(t=w(e),t===null)throw Error(d(188));return t!==e?null:e}for(var a=e,c=t;;){var n=a.return;if(n===null)break;var i=n.alternate;if(i===null){if(c=n.return,c!==null){a=c;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===a)return S(n),e;if(i===c)return S(n),t;i=i.sibling}throw Error(d(188))}if(a.return!==c.return)a=n,c=i;else{for(var o=!1,h=n.child;h;){if(h===a){o=!0,a=n,c=i;break}if(h===c){o=!0,c=n,a=i;break}h=h.sibling}if(!o){for(h=i.child;h;){if(h===a){o=!0,a=i,c=n;break}if(h===c){o=!0,c=i,a=n;break}h=h.sibling}if(!o)throw Error(d(189))}}if(a.alternate!==c)throw Error(d(190))}if(a.tag!==3)throw Error(d(188));return a.stateNode.current===a?e:t}function B(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=B(e),t!==null)return t;e=e.sibling}return null}var I=Object.assign,O=Symbol.for("react.element"),Q=Symbol.for("react.transitional.element"),P=Symbol.for("react.portal"),G=Symbol.for("react.fragment"),X=Symbol.for("react.strict_mode"),ie=Symbol.for("react.profiler"),he=Symbol.for("react.consumer"),oe=Symbol.for("react.context"),Se=Symbol.for("react.forward_ref"),_e=Symbol.for("react.suspense"),Pe=Symbol.for("react.suspense_list"),le=Symbol.for("react.memo"),Ye=Symbol.for("react.lazy"),A1=Symbol.for("react.activity"),_2=Symbol.for("react.memo_cache_sentinel"),q1=Symbol.iterator;function Qe(e){return e===null||typeof e!="object"?null:(e=q1&&e[q1]||e["@@iterator"],typeof e=="function"?e:null)}var Ct=Symbol.for("react.client.reference");function B1(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Ct?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case G:return"Fragment";case ie:return"Profiler";case X:return"StrictMode";case _e:return"Suspense";case Pe:return"SuspenseList";case A1:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case P:return"Portal";case oe:return e.displayName||"Context";case he:return(e._context.displayName||"Context")+".Consumer";case Se:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case le:return t=e.displayName||null,t!==null?t:B1(e.type)||"Memo";case Ye:t=e._payload,e=e._init;try{return B1(e(t))}catch{}}return null}var b1=Array.isArray,z=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,D=p.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,N={pending:!1,data:null,method:null,action:null},ke=[],me=-1;function k(e){return{current:e}}function j(e){0>me||(e.current=ke[me],ke[me]=null,me--)}function V(e,t){me++,ke[me]=e.current,e.current=t}var R=k(null),K=k(null),$=k(null),re=k(null);function Ge(e,t){switch(V($,t),V(K,e),V(R,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?rz(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=rz(t),e=sz(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}j(R),V(R,e)}function ze(){j(R),j(K),j($)}function wa(e){e.memoizedState!==null&&V(re,e);var t=R.current,a=sz(t,e.type);t!==a&&(V(K,e),V(R,a))}function bc(e){K.current===e&&(j(R),j(K)),re.current===e&&(j(re),pc._currentValue=N)}var dx,Zb;function zt(e){if(dx===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);dx=t&&t[1]||"",Zb=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+dx+e+Zb}var ux=!1;function rx(e,t){if(!e||ux)return"";ux=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var c={DetermineComponentFrameRoot:function(){try{if(t){var H=function(){throw Error()};if(Object.defineProperty(H.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(H,[])}catch(b){var L=b}Reflect.construct(e,[],H)}else{try{H.call()}catch(b){L=b}e.call(H.prototype)}}else{try{throw Error()}catch(b){L=b}(H=e())&&typeof H.catch=="function"&&H.catch(function(){})}}catch(b){if(b&&L&&typeof b.stack=="string")return[b.stack,L.stack]}return[null,null]}};c.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var n=Object.getOwnPropertyDescriptor(c.DetermineComponentFrameRoot,"name");n&&n.configurable&&Object.defineProperty(c.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var i=c.DetermineComponentFrameRoot(),o=i[0],h=i[1];if(o&&h){var u=o.split(`
`),g=h.split(`
 ...
 *
 * @license MIT
 */function xc(){return xc=Object.assign?Object.assign.bind():function(y){for(var r=1;r<arguments.length;r++){var p=arguments[r];for(var d in p)Object.prototype.hasOwnProperty.call(p,d)&&(y[d]=p[d])}return y},xc.apply(this,arguments)}var O2;(function(y){y.Pop="POP",y.Push="PUSH",y.Replace="REPLACE"})(O2||(O2={}));const $z="popstate";function Uj(y){y===void 0&&(y={});function r(x,w){let{pathname:q="/",search:T="",hash:S=""}=Lc(x.location.hash.substr(1));return!q.startsWith("/")&&!q.startsWith(".")&&(q="/"+q),Vb("",{pathname:q,search:T,hash:S},w.state&&w.state.usr||null,w.state&&w.state.key||"default")}function p(x,w){let q=x.document.querySelector("base"),T="";if(q&&q.getAttribute("href")){let S=x.location.href,v=S.indexOf("#");T=v===-1?S:S.slice(0,v)}return T+"#"+(typeof w=="string"?w:nx(w))}function d(x,w){kA(x.pathname.charAt(0)==="/","relative pathnames are not supported in hash history.push("+JSON.stringify(w)+")")}return Zj(r,p,d,y)}function z1(y,r){if(y===!1||y===null||typeof y>"u")throw new Error(r)}function kA(y,r){if(!y){typeof console<"u"&&console.warn(r);try{throw new Error(r)}catch{}}}function Ej(){return Math.random().toString(36).substr(2,8)}function eA(y,r){return{usr:y.state,key:y.key,idx:r}}function Vb(y,r,p,d){return p===void 0&&(p=null),xc({pathname:typeof y=="string"?y:y.pathname,search:"",hash:""},typeof r=="string"?Lc(r):r,{state:p,key:r&&r.key||d||Ej()})}function nx(y){let{pathname:r="/",search:p="",hash:d=""}=y;return p&&p!=="?"&&(r+=p.charAt(0)==="?"?p:"?"+p),d&&d!=="#"&&(r+=d.charAt(0)==="#"?d:"#"+d),r}function Lc(y){let r={};if(y){let p=y.indexOf("#");p>=0&&(r.hash=y.substr(p),y=y.substr(0,p));let d=y.indexOf("?");d>=0&&(r.search=y.substr(d),y=y.substr(0,d)),y&&(r.pathname=y)}return r}function Zj(y,r,p,d){d===void 0&&(d={});let{window:x=document.defaultView,v5Compat:w=!1}=d,q=x.history,T=O2.Pop,S=null,v=B();v==null&&(v=0,q.replaceState(xc({},q.state,{idx:v}),""));function B(){return(q.state||{idx:null}).idx}function I(){T=O2.Pop;let X=B(),ie=X==null?null:X-v;v=X,S&&S({action:T,location:G.location,delta:ie})}function O(X,ie){T=O2.Push;let he=Vb(G.location,X,ie);p&&p(he,X),v=B()+1;let oe=eA(he,v),Se=G.createHref(he);try{q.pushState(oe,"",Se)}catch(_e){if(_e instanceof DOMException&&_e.name==="DataCloneError")throw _e;x.location.assign(Se)}w&&S&&S({action:T,location:G.location,delta:1})}function Q(X,ie){T=O2.Replace;let he=Vb(G.location,X,ie);p&&p(he,X),v=B();let oe=eA(he,v),Se=G.createHref(he);q.replaceState(oe,"",Se),w&&S&&S({action:T,location:G.location,delta:0})}function P(X){let ie=x.location.origin!=="null"?x.location.origin:x.location.href,he=typeof X=="string"?X:nx(X);return he=he.replace(/ $/,"%20"),z1(ie,"No window.location.(origin|href) available to create URL for href: "+he),new URL(he,ie)}let G={get action(){return T},get location(){return y(x,q)},listen(X){if(S)throw new Error("A history only accepts one active listener");return x.addEventListener($z,I),S=X,()=>{x.removeEventListener($z,I),S=null}},createHref(X){return r(x,X)},createURL:P,encodeLocation(X){let ie=P(X);return{pathname:ie.pathname,search:ie.search,hash:ie.hash}},push:O,replace:Q,go(X){return q.go(X)}};return G}var tA;(function(y){y.data="data",y.deferred="deferred",y.redirect="redirect",y.error="error"})(tA||(tA={}));function fA(y,r){if(r==="/")return y;if(!y.toLowerCase().startsWith(r.toLowerCase()))return null;let p=r.endsWith("/")?r.length-1:r.length,d=y.charAt(p);return d&&d!=="/"?null:y.slice(p)||"/"}const Fj=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Nj=y=>Fj.test(y);function Gj(y,r){r===void 0&&(r="/");let{pathname:p,search:d="",hash:x=""}=typeof y=="string"?Lc(y):y,w;if(p)if(Nj(p))w=p;else{if(p.includes("//")){let q=p;p=p.replace(/\/\/+/g,"/"),kA(!1,"Pathnames cannot have embedded double slashes - normalizing "+(q+" -> "+p))}p.startsWith("/")?w=aA(p.substring(1),"/"):w=aA(p,r)}else w=r;return{pathname:w,search:Pj(d),hash:Yj(x)}}function aA(y,r){let p=r.replace(/\/+$/,"").split("/");return y.split("/").forEach(x=>{x===".."?p.length>1&&p.pop():x!=="."&&p.push(x)}),p.length>1?p.join("/"):"/"}function Db(y,r,p,d){return"Cannot include a '"+y+"' character in a manually specified "+("`to."+r+"` field ["+JSON.stringify(d)+"].  Please separate it out to the ")+("`to."+p+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Xj(y){return y.filter((r,p)=>p===0||r.route.path&&r.route.path.length>0)}function MA(y,r){let p=Xj(y);return r?p.map((d,x)=>x===p.length-1?d.pathname:d.pathnameBase):p.map(d=>d.pathnameBase)}function vA(y,r,p,d){d===void 0&&(d=!1);let x;typeof y=="string"?x=Lc(y):(x=xc({},y),z1(!x.pathname||!x.pathname.includes("?"),Db("?","pathname","search",x)),z1(!x.pathname||!x.pathname.includes("#"),Db("#","pathname","hash",x)),z1(!x.search||!x.search.includes("#"),Db("#","search","hash",x)));let w=y===""||x.pathname==="",q=w?"/":x.pathname,T;if(q==null)T=p;else{let I=r.length-1;if(!d&&q.startsWith("..")){let O=q.split("/");for(;O[0]==="..";)O.shift(),I-=1;x.pathname=O.join("/")}T=I>=0?r[I]:"/"}let S=Gj(x,T),v=q&&q!=="/"&&q.endsWith("/"),B=(w||q===".")&&p.endsWith("/");return!S.pathname.endsWith("/")&&(v||B)&&(S.pathname+="/"),S}const mA=y=>y.join("/").replace(/\/\/+/g,"/"),Pj=y=>!y||y==="?"?"":y.startsWith("?")?y:"?"+y,Yj=y=>!y||y==="#"?"":y.startsWith("#")?y:"#"+y,gA=["post","put","patch","delete"];new Set(gA);const Qj=["get",...gA];new Set(Qj);/**
 ...
 *
 * @license MIT
 */function ix(){return ix=Object.assign?Object.assign.bind():function(y){for(var r=1;r<arguments.length;r++){var p=arguments[r];for(var d in p)Object.prototype.hasOwnProperty.call(p,d)&&(y[d]=p[d])}return y},ix.apply(this,arguments)}const xA=E.createContext(null),Sa=E.createContext(null),_b=E.createContext(null),ox=E.createContext({outlet:null,matches:[],isDataRoute:!1});function Kj(y,r){let{relative:p}=r===void 0?{}:r;hx()||z1(!1);let{basename:d,navigator:x}=E.useContext(Sa),{hash:w,pathname:q,search:T}=bA(y,{relative:p}),S=q;return d!=="/"&&(S=q==="/"?d:mA([d,q])),x.createHref({pathname:S,search:T,hash:w})}function hx(){return E.useContext(_b)!=null}function Rb(){return hx()||z1(!1),E.useContext(_b).location}function LA(y){E.useContext(Sa).static||E.useLayoutEffect(y)}function Jj(){let{isDataRoute:y}=E.useContext(ox);return y?aI():Wj()}function Wj(){hx()||z1(!1);let y=E.useContext(xA),{basename:r,future:p,navigator:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:w}=Rb(),q=JSON.stringify(MA(x,p.v7_relativeSplatPath)),T=E.useRef(!1);return LA(()=>{T.current=!0}),E.useCallback(function(v,B){if(B===void 0&&(B={}),!T.current)return;if(typeof v=="number"){d.go(v);return}let I=vA(v,JSON.parse(q),w,B.relative==="path");y==null&&r!=="/"&&(I.pathname=I.pathname==="/"?r:mA([r,I.pathname])),(B.replace?d.replace:d.push)(I,B.state,B)},[r,d,q,w,y])}function bA(y,r){let{relative:p}=r===void 0?{}:r,{future:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:w}=Rb(),q=JSON.stringify(MA(x,d.v7_relativeSplatPath));return E.useMemo(()=>vA(y,JSON.parse(q),w,p==="path"),[y,q,w,p])}var SA=(function(y){return y.UseBlocker="useBlocker",y.UseRevalidator="useRevalidator",y.UseNavigateStable="useNavigate",y})(SA||{}),wA=(function(y){return y.UseBlocker="useBlocker",y.UseLoaderData="useLoaderData",y.UseActionData="useActionData",y.UseRouteError="useRouteError",y.UseNavigation="useNavigation",y.UseRouteLoaderData="useRouteLoaderData",y.UseMatches="useMatches",y.UseRevalidator="useRevalidator",y.UseNavigateStable="useNavigate",y.UseRouteId="useRouteId",y})(wA||{});function $j(y){let r=E.useContext(xA);return r||z1(!1),r}function eI(y){let r=E.useContext(ox);return r||z1(!1),r}function tI(y){let r=eI(),p=r.matches[r.matches.length-1];return p.route.id||z1(!1),p.route.id}function aI(){let{router:y}=$j(SA.UseNavigateStable),r=tI(wA.UseNavigateStable),p=E.useRef(!1);return LA(()=>{p.current=!0}),E.useCallback(function(x,w){w===void 0&&(w={}),p.current&&(typeof x=="number"?y.navigate(x):y.navigate(x,ix({fromRouteId:r},w)))},[y,r])}function cI(y,r){y==null||y.v7_startTransition,y==null||y.v7_relativeSplatPath}function lI(y){let{basename:r="/",children:p=null,location:d,navigationType:x=O2.Pop,navigator:w,static:q=!1,future:T}=y;hx()&&z1(!1);let S=r.replace(/^\/*/,"/"),v=E.useMemo(()=>({basename:S,navigator:w,static:q,future:ix({v7_relativeSplatPath:!1},T)}),[S,T,w,q]);typeof d=="string"&&(d=Lc(d));let{pathname:B="/",search:I="",hash:O="",state:Q=null,key:P="default"}=d,G=E.useMemo(()=>{let X=fA(B,S);return X==null?null:{location:{pathname:X,search:I,hash:O,state:Q,key:P},navigationType:x}},[S,B,I,O,Q,P,x]);return G==null?null:E.createElement(Sa.Provider,{value:v},E.createElement(_b.Provider,{children:p,value:G}))}new Promise(()=>{});/**
 ...
 *
 * @license MIT
 */function Bb(){return Bb=Object.assign?Object.assign.bind():function(y){for(var r=1;r<arguments.length;r++){var p=arguments[r];for(var d in p)Object.prototype.hasOwnProperty.call(p,d)&&(y[d]=p[d])}return y},Bb.apply(this,arguments)}function nI(y,r){if(y==null)return{};var p={},d=Object.keys(y),x,w;for(w=0;w<d.length;w++)x=d[w],!(r.indexOf(x)>=0)&&(p[x]=y[x]);return p}function iI(y){return!!(y.metaKey||y.altKey||y.ctrlKey||y.shiftKey)}function oI(y,r){return y.button===0&&(!r||r==="_self")&&!iI(y)}const hI=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],yI="6";try{window.__reactRouterVersion=yI}catch{}const dI="startTransition",cA=jj[dI];function uI(y){let{basename:r,children:p,future:d,window:x}=y,w=E.useRef();w.current==null&&(w.current=Uj({window:x,v5Compat:!0}));let q=w.current,[T,S]=E.useState({action:q.action,location:q.location}),{v7_startTransition:v}=d||{},B=E.useCallback(I=>{v&&cA?cA(()=>S(I)):S(I)},[S,v]);return E.useLayoutEffect(()=>q.listen(B),[q,B]),E.useEffect(()=>cI(d),[d]),E.createElement(lI,{basename:r,children:p,location:T.location,navigationType:T.action,navigator:q,future:d})}const rI=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",sI=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,pI=E.forwardRef(function(r,p){let{onClick:d,relative:x,reloadDocument:w,replace:q,state:T,target:S,to:v,preventScrollReset:B,viewTransition:I}=r,O=nI(r,hI),{basename:Q}=E.useContext(Sa),P,G=!1;if(typeof v=="string"&&sI.test(v)&&(P=v,rI))try{let oe=new URL(window.location.href),Se=v.startsWith("//")?new URL(oe.protocol+v):new URL(v),_e=fA(Se.pathname,Q);Se.origin===oe.origin&&_e!=null?v=_e+Se.search+Se.hash:G=!0}catch{}let X=Kj(v,{relative:x}),ie=kI(v,{replace:q,state:T,target:S,preventScrollReset:B,relative:x,viewTransition:I});function he(oe){d&&d(oe),oe.defaultPrevented||ie(oe)}return E.createElement("a",Bb({},O,{href:P||X,onClick:G||w?d:he,ref:p,target:S}))});var lA;(function(y){y.UseScrollRestoration="useScrollRestoration",y.UseSubmit="useSubmit",y.UseSubmitFetcher="useSubmitFetcher",y.UseFetcher="useFetcher",y.useViewTransitionState="useViewTransitionState"})(lA||(lA={}));var nA;(function(y){y.UseFetcher="useFetcher",y.UseFetchers="useFetchers",y.UseScrollRestoration="useScrollRestoration"})(nA||(nA={}));function kI(y,r){let{target:p,replace:d,state:x,preventScrollReset:w,relative:q,viewTransition:T}=r===void 0?{}:r,S=Jj(),v=Rb(),B=bA(y,{relative:q});return E.useCallback(I=>{if(oI(I,p)){I.preventDefault();let O=d!==void 0?d:nx(v)===nx(B);S(y,{replace:O,state:x,preventScrollReset:w,relative:q,viewTransition:T})}},[v,S,B,d,x,p,y,w,q,T])}const CA=E.createContext(),fI=({children:y})=>{const[r,p]=E.useState([]),[d,x]=E.useState(!1);E.useEffect(()=>{const I=localStorage.getItem("athena_cart");if(I)try{p(JSON.parse(I))}catch(O){console.error("Failed to parse cart",O)}},[]),E.useEffect(()=>{localStorage.setItem("athena_cart",JSON.stringify(r))},[r]);const w=E.useCallback(I=>{p(O=>O.find(P=>P.id===I.id)?O.map(P=>P.id===I.id?{...P,quantity:P.quantity+1}:P):[...O,{...I,quantity:1}]),x(!0)},[]),q=E.useCallback((I,O)=>{p(Q=>Q.map(P=>{if(P.id===I){const G=Math.max(0,P.quantity+O);return{...P,quantity:G}}return P}).filter(P=>P.quantity>0))},[]),T=E.useCallback(()=>p([]),[]),S=E.useMemo(()=>r.reduce((I,O)=>I+O.price*O.quantity,0),[r]),v=E.useMemo(()=>r.reduce((I,O)=>I+O.quantity,0),[r]),B=E.useMemo(()=>({cart:r,addToCart:w,updateQuantity:q,clearCart:T,cartTotal:S,cartCount:v,isCartOpen:d,setIsCartOpen:x}),[r,w,q,T,S,v,d]);return M.jsx(CA.Provider,{value:B,children:y})},MI=()=>{const y=E.useContext(CA);if(!y)throw new Error("useCart must be used within a CartProvider");return y},zA=E.createContext(),yx=()=>E.useContext(zA),vI=({children:y,data:r})=>{const[p,d]=E.useState(r.display_config||{sections:{}});E.useEffect(()=>{r.display_config&&d(r.display_config)},[r.display_config]);const x=(q,T)=>{var v;const S=(v=p.sections)==null?void 0:v[q];return S?!(S.hidden_fields&&S.hidden_fields.includes(T)):!0},w=q=>{var S;const T=(S=p.sections)==null?void 0:S[q];return T?T.visible!==!1:!0};return M.jsx(zA.Provider,{value:{config:p,isFieldVisible:x,isSectionVisible:w},children:y})};function Ve({tagName:y="span",value:r,children:p,cmsBind:d,table:x,field:w,id:q,className:T="",style:S={},renderValue:v,...B}){const{isFieldVisible:I}=yx(),O=r!==void 0?r:p,Q=d||{file:x,key:w,index:q||0};if(!I(Q.file,Q.key))return null;const[P,G]=ba.useState({});ba.useEffect(()=>{},[Q.file,Q.index,Q.key]);const X=v?v(O):typeof O=="object"&&O!==null&&!ba.isValidElement(O)?O.text||O.title||O.label||JSON.stringify(O):O;return M.jsx(y,{className:T,style:{...S,...P},...B,children:X})}function Ub({src:y,alt:r,className:p,cmsBind:d,dataItem:x={},fallback:w,...q}){const{isFieldVisible:T}=yx(),[S,v]=E.useState(!1);if(d&&!T(d.file,d.key))return null;const I=y&&y!==""&&!y.startsWith("http")&&!y.startsWith("/")&&!y.startsWith("data:")?`./images/${y}`.replace(/\/+/g,"/"):y||null,O=I&&(I.endsWith(".mp4")||I.endsWith(".webm")||I.includes("video")),Q=`${d==null?void 0:d.key}_loop`,P=x[Q]!==!1&&x[Q]!=="false";return!I||S?typeof w=="string"&&w.length<=2?M.jsx("div",{className:"w-full h-full bg-accent flex items-center justify-center text-white font-serif font-black",children:w}):null:O?M.jsx("video",{src:I,autoPlay:!0,loop:P,muted:!0,playsInline:!0,className:p,...q}):M.jsx("img",{src:I,alt:r,className:p,onError:()=>v(!0),...q})}function mI({siteSettings:y={}}){const r=Array.isArray(y)?y[0]||{}:y||{},p=r.site_name||"karel-portfolio-ath",d=(r.logo_text||p).charAt(0).toUpperCase(),x=r.site_logo_image||"athena-icon.svg";return M.jsx("nav",{className:"fixed top-0 left-0 right-0 z-[1000] border-b border-white/5 px-6 py-5 transition-all duration-500 bg-black/80 backdrop-blur-xl",children:M.jsxs("div",{className:"max-w-7xl mx-auto flex justify-between items-center",children:[M.jsxs(pI,{to:"/",className:"flex items-center gap-4 group",children:[M.jsx("div",{className:"relative w-12 h-12 overflow-hidden rounded-full shadow-xl shadow-accent/20 group-hover:scale-105 transition-transform duration-500 bg-accent",children:M.jsx(Ub,{src:x,cmsBind:{file:"site_settings",index:0,key:"site_logo_image"},className:"w-full h-full object-contain",fallback:d})}),M.jsxs("div",{className:"flex flex-col",children:[M.jsx("span",{className:"text-2xl font-serif font-black tracking-tight text-white leading-none mb-1",children:M.jsx(Ve,{value:p,cmsBind:{file:"site_settings",index:0,key:"site_name"}})}),r.tagline&&M.jsx("span",{className:"text-[10px] uppercase tracking-[0.3em] text-accent font-bold opacity-80",children:M.jsx(Ve,{value:r.tagline,cmsBind:{file:"site_settings",index:0,key:"tagline"}})})]})]}),M.jsx("div",{className:"hidden md:flex items-center gap-8",children:M.jsx("a",{href:"#contact",className:"bg-accent text-white px-6 py-3 rounded-xl font-bold hover:bg-accent/80 transition-colors",children:"Contact"})})]})})}function iA({href:y,value:r,children:p,table:d,field:x,id:w=0,cmsBind:q,className:T="",tagName:S="a",...v}){const{isFieldVisible:B}=yx(),I=q||{file:d,key:x},O=r!==void 0?r:p;return I.file&&!B(I.file,I.key)?null:M.jsx(S,{href:y,className:T,...v,children:O})}const gI=({profile:y})=>M.jsxs("section",{className:"relative pt-32 pb-20 px-6 overflow-hidden",children:[M.jsxs("div",{className:"max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12",children:[M.jsxs("div",{className:"flex-1 text-center md:text-left z-10",children:[M.jsx("h2",{className:"text-blue-500 font-black uppercase tracking-[0.3em] mb-4 text-sm",children:M.jsx(Ve,{table:"profile",field:"professional_title",id:0,value:y.professional_title})}),M.jsx("h1",{className:"text-5xl md:text-8xl font-black mb-8 leading-[0.9] tracking-tighter uppercase",children:M.jsx(Ve,{table:"profile",field:"full_name",id:0,value:y.full_name})}),M.jsx("p",{className:"text-xl text-zinc-400 mb-10 max-w-xl leading-relaxed",children:M.jsx(Ve,{table:"profile",field:"bio_short",id:0,value:y.bio_short})}),M.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 justify-center md:justify-start",children:[M.jsx(iA,{href:"#contact",table:"profile",field:"cta_text",id:0,value:y.cta_text||"Hire Me",className:"bg-white text-black px-10 py-5 rounded-full font-black uppercase text-sm hover:bg-blue-500 hover:text-white transition-all duration-500 flex items-center justify-center"}),M.jsx(iA,{href:"#projects",className:"border border-white/10 px-10 py-5 rounded-full font-black uppercase text-sm hover:bg-white/5 transition-all flex items-center justify-center",children:"View Work"})]})]}),M.jsx("div",{className:"flex-1 relative",children:M.jsxs("div",{className:"relative w-72 h-72 md:w-[500px] md:h-[500px] mx-auto",children:[M.jsx("div",{className:"absolute inset-0 bg-blue-600 blur-[120px] opacity-20 rounded-full animate-pulse"}),M.jsx("div",{className:"relative h-full w-full rounded-full overflow-hidden border border-white/10 group",children:M.jsx(Ub,{src:y.avatar_url,alt:y.full_name,className:"w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700",cmsBind:{file:"profile",index:0,key:"avatar_url"}})})]})})]}),M.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20vw] font-black text-white/[0.02] whitespace-nowrap pointer-events-none select-none",children:"PORTFOLIO"})]}),Eb=({file:y,index:r,isHidden:p})=>null,xI=({projects:y})=>M.jsx("section",{id:"projects",className:"py-32 px-6",children:M.jsxs("div",{className:"max-w-7xl mx-auto",children:[M.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-end mb-20 gap-8",children:[M.jsxs("div",{className:"max-w-2xl",children:[M.jsx("h2",{className:"text-blue-500 font-black uppercase tracking-[0.3em] mb-4 text-sm",children:"Selected Work"}),M.jsxs("h3",{className:"text-5xl md:text-7xl font-black tracking-tighter uppercase leading-[0.9]",children:["Innovation in Every ",M.jsx("span",{className:"text-zinc-800",children:"Pixel"})]})]}),M.jsx("p",{className:"text-zinc-500 max-w-xs text-sm uppercase font-bold tracking-widest leading-loose",children:"Explorations in full-stack development, AI integration, and user-centric design."})]}),M.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10",children:y.map((r,p)=>M.jsxs("div",{className:"group relative",children:[M.jsx(Eb,{file:"projects",index:p,isHidden:r.hidden}),M.jsxs("div",{className:"relative aspect-[16/10] rounded-[40px] overflow-hidden bg-zinc-900 border border-white/5 mb-8",children:[M.jsx(Ub,{src:r.image_url,alt:r.title,className:"w-full h-full object-cover opacity-60 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700",cmsBind:{file:"projects",index:p,key:"image_url"}}),M.jsx("div",{className:"absolute top-6 left-6",children:M.jsx("span",{className:"px-4 py-2 bg-black/50 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest border border-white/10",children:M.jsx(Ve,{table:"projects",field:"category",id:p,value:r.category})})})]}),M.jsxs("div",{className:"flex justify-between items-start gap-4",children:[M.jsxs("div",{children:[M.jsx("h4",{className:"text-3xl font-black uppercase tracking-tighter mb-2",children:M.jsx(Ve,{table:"projects",field:"title",id:p,value:r.title})}),M.jsx("p",{className:"text-zinc-500 text-sm max-w-sm",children:M.jsx(Ve,{table:"projects",field:"summary",id:p,value:r.summary})})]}),M.jsx("button",{className:"w-16 h-16 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all duration-500",children:M.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:M.jsx("path",{d:"M7 17l10-10M7 7h10v10"})})})]})]},p))})]})});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bI=y=>y.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),l=(y,r)=>{const p=E.forwardRef(({color:d="currentColor",size:x=24,strokeWidth:w=2,absoluteStrokeWidth:q,className:T="",children:S,...v},B)=>E.createElement("svg",{ref:B,...LI,width:x,height:x,stroke:d,strokeWidth:q?Number(w)*24/Number(x):w,className:["lucide",`lucide-${bI(y)}`,T].join(" "),...v},[...r.map(([I,O])=>E.createElement(I,O)),...Array.isArray(S)?S:[S]]));return p.displayName=`${y}`,p};/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
