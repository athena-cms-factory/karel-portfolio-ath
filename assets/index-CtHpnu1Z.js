 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gz;function Hj(){if(Gz)return P;Gz=1;var h=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),C=Symbol.for("react.consumer"),H=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),k=Symbol.for("react.memo"),D=Symbol.for("react.lazy"),j=Symbol.for("react.activity"),B=Symbol.iterator;function $(p){return p===null||typeof p!="object"?null:(p=B&&p[B]||p["@@iterator"],typeof p=="function"?p:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ce=Object.assign,X={};function F(p,I,O){this.props=p,this.context=I,this.refs=X,this.updater=O||Y}F.prototype.isReactComponent={},F.prototype.setState=function(p,I){if(typeof p!="object"&&typeof p!="function"&&p!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,p,I,"setState")},F.prototype.forceUpdate=function(p){this.updater.enqueueForceUpdate(this,p,"forceUpdate")};function de(){}de.prototype=F.prototype;function ue(p,I,O){this.props=p,this.context=I,this.refs=X,this.updater=O||Y}var Q=ue.prototype=new de;Q.constructor=ue,ce(Q,F.prototype),Q.isPureReactComponent=!0;var we=Array.isArray;function Pe(){}var ie={H:null,A:null,T:null,S:null},Ye=Object.prototype.hasOwnProperty;function A1(p,I,O){var R=O.ref;return{$$typeof:h,type:p,key:I,ref:R!==void 0?R:null,props:O}}function _2(p,I){return A1(p.type,I,p.props)}function q1(p){return typeof p=="object"&&p!==null&&p.$$typeof===h}function Qe(p){var I={"=":"=0",":":"=2"};return"$"+p.replace(/[=:]/g,function(O){return I[O]})}var Ct=/\/+/g;function B1(p,I){return typeof p=="object"&&p!==null&&p.key!=null?Qe(""+p.key):I.toString(36)}function b1(p){switch(p.status){case"fulfilled":return p.value;case"rejected":throw p.reason;default:switch(typeof p.status=="string"?p.then(Pe,Pe):(p.status="pending",p.then(function(I){p.status==="pending"&&(p.status="fulfilled",p.value=I)},function(I){p.status==="pending"&&(p.status="rejected",p.reason=I)})),p.status){case"fulfilled":return p.value;case"rejected":throw p.reason}}throw p}function z(p,I,O,R,K){var ee=typeof p;(ee==="undefined"||ee==="boolean")&&(p=null);var se=!1;if(p===null)se=!0;else switch(ee){case"bigint":case"string":case"number":se=!0;break;case"object":switch(p.$$typeof){case h:case s:se=!0;break;case D:return se=p._init,z(se(p._payload),I,O,R,K)}}if(se)return K=K(p),se=R===""?"."+B1(p,0):R,we(K)?(O="",se!=null&&(O=se.replace(Ct,"$&/")+"/"),z(K,I,O,"",function(wa){return wa})):K!=null&&(q1(K)&&(K=_2(K,O+(K.key==null||p&&p.key===K.key?"":(""+K.key).replace(Ct,"$&/")+"/")+se)),I.push(K)),1;se=0;var Ge=R===""?".":R+":";if(we(p))for(var Ae=0;Ae<p.length;Ae++)R=p[Ae],ee=Ge+B1(R,Ae),se+=z(R,I,O,ee,K);else if(Ae=$(p),typeof Ae=="function")for(p=Ae.call(p),Ae=0;!(R=p.next()).done;)R=R.value,ee=Ge+B1(R,Ae++),se+=z(R,I,O,ee,K);else if(ee==="object"){if(typeof p.then=="function")return z(b1(p),I,O,R,K);throw I=String(p),Error("Objects are not valid as a React child (found: "+(I==="[object Object]"?"object with keys {"+Object.keys(p).join(", ")+"}":I)+"). If you meant to render a collection of children, use an array instead.")}return se}function V(p,I,O){if(p==null)return p;var R=[],K=0;return z(p,R,"","",function(ee){return I.call(O,ee,K++)}),R}function G(p){if(p._status===-1){var I=p._result;I=I(),I.then(function(O){(p._status===0||p._status===-1)&&(p._status=1,p._result=O)},function(O){(p._status===0||p._status===-1)&&(p._status=2,p._result=O)}),p._status===-1&&(p._status=0,p._result=I)}if(p._status===1)return p._result.default;throw p._result}var fe=typeof reportError=="function"?reportError:function(p){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var I=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof p=="object"&&p!==null&&typeof p.message=="string"?String(p.message):String(p),error:p});if(!window.dispatchEvent(I))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",p);return}console.error(p)},ge={map:V,forEach:function(p,I,O){V(p,function(){I.apply(this,arguments)},O)},count:function(p){var I=0;return V(p,function(){I++}),I},toArray:function(p){return V(p,function(I){return I})||[]},only:function(p){if(!q1(p))throw Error("React.Children.only expected to receive a single React element child.");return p}};return P.Activity=j,P.Children=ge,P.Component=F,P.Fragment=f,P.Profiler=x,P.PureComponent=ue,P.StrictMode=d,P.Suspense=b,P.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ie,P.__COMPILER_RUNTIME={__proto__:null,c:function(p){return ie.H.useMemoCache(p)}},P.cache=function(p){return function(){return p.apply(null,arguments)}},P.cacheSignal=function(){return null},P.cloneElement=function(p,I,O){if(p==null)throw Error("The argument must be a React element, but you passed "+p+".");var R=ce({},p.props),K=p.key;if(I!=null)for(ee in I.key!==void 0&&(K=""+I.key),I)!Ye.call(I,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&I.ref===void 0||(R[ee]=I[ee]);var ee=arguments.length-2;if(ee===1)R.children=O;else if(1<ee){for(var se=Array(ee),Ge=0;Ge<ee;Ge++)se[Ge]=arguments[Ge+2];R.children=se}return A1(p.type,K,R)},P.createContext=function(p){return p={$$typeof:H,_currentValue:p,_currentValue2:p,_threadCount:0,Provider:null,Consumer:null},p.Provider=p,p.Consumer={$$typeof:C,_context:p},p},P.createElement=function(p,I,O){var R,K={},ee=null;if(I!=null)for(R in I.key!==void 0&&(ee=""+I.key),I)Ye.call(I,R)&&R!=="key"&&R!=="__self"&&R!=="__source"&&(K[R]=I[R]);var se=arguments.length-2;if(se===1)K.children=O;else if(1<se){for(var Ge=Array(se),Ae=0;Ae<se;Ae++)Ge[Ae]=arguments[Ae+2];K.children=Ge}if(p&&p.defaultProps)for(R in se=p.defaultProps,se)K[R]===void 0&&(K[R]=se[R]);return A1(p,ee,K)},P.createRef=function(){return{current:null}},P.forwardRef=function(p){return{$$typeof:T,render:p}},P.isValidElement=q1,P.lazy=function(p){return{$$typeof:D,_payload:{_status:-1,_result:p},_init:G}},P.memo=function(p,I){return{$$typeof:k,type:p,compare:I===void 0?null:I}},P.startTransition=function(p){var I=ie.T,O={};ie.T=O;try{var R=p(),K=ie.S;K!==null&&K(O,R),typeof R=="object"&&R!==null&&typeof R.then=="function"&&R.then(Pe,fe)}catch(ee){fe(ee)}finally{I!==null&&O.types!==null&&(I.types=O.types),ie.T=I}},P.unstable_useCacheRefresh=function(){return ie.H.useCacheRefresh()},P.use=function(p){return ie.H.use(p)},P.useActionState=function(p,I,O){return ie.H.useActionState(p,I,O)},P.useCallback=function(p,I){return ie.H.useCallback(p,I)},P.useContext=function(p){return ie.H.useContext(p)},P.useDebugValue=function(){},P.useDeferredValue=function(p,I){return ie.H.useDeferredValue(p,I)},P.useEffect=function(p,I){return ie.H.useEffect(p,I)},P.useEffectEvent=function(p){return ie.H.useEffectEvent(p)},P.useId=function(){return ie.H.useId()},P.useImperativeHandle=function(p,I,O){return ie.H.useImperativeHandle(p,I,O)},P.useInsertionEffect=function(p,I){return ie.H.useInsertionEffect(p,I)},P.useLayoutEffect=function(p,I){return ie.H.useLayoutEffect(p,I)},P.useMemo=function(p,I){return ie.H.useMemo(p,I)},P.useOptimistic=function(p,I){return ie.H.useOptimistic(p,I)},P.useReducer=function(p,I,O){return ie.H.useReducer(p,I,O)},P.useRef=function(p){return ie.H.useRef(p)},P.useState=function(p){return ie.H.useState(p)},P.useSyncExternalStore=function(p,I,O){return ie.H.useSyncExternalStore(p,I,O)},P.useTransition=function(){return ie.H.useTransition()},P.version="19.2.4",P}var Xz;function Ob(){return Xz||(Xz=1,qb.exports=Hj()),qb.exports}var E=Ob();const ba=sA(E),jj=JH({__proto__:null,default:ba},[E]);var Hb={exports:{}},mc={},jb={exports:{}},Ib={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pz;function Ij(){return Pz||(Pz=1,(function(h){function s(z,V){var G=z.length;z.push(V);e:for(;0<G;){var fe=G-1>>>1,ge=z[fe];if(0<x(ge,V))z[fe]=V,z[G]=ge,G=fe;else break e}}function f(z){return z.length===0?null:z[0]}function d(z){if(z.length===0)return null;var V=z[0],G=z.pop();if(G!==V){z[0]=G;e:for(var fe=0,ge=z.length,p=ge>>>1;fe<p;){var I=2*(fe+1)-1,O=z[I],R=I+1,K=z[R];if(0>x(O,G))R<ge&&0>x(K,O)?(z[fe]=K,z[R]=G,fe=R):(z[fe]=O,z[I]=G,fe=I);else if(R<ge&&0>x(K,G))z[fe]=K,z[R]=G,fe=R;else break e}}return V}function x(z,V){var G=z.sortIndex-V.sortIndex;return G!==0?G:z.id-V.id}if(h.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;h.unstable_now=function(){return C.now()}}else{var H=Date,T=H.now();h.unstable_now=function(){return H.now()-T}}var b=[],k=[],D=1,j=null,B=3,$=!1,Y=!1,ce=!1,X=!1,F=typeof setTimeout=="function"?setTimeout:null,de=typeof clearTimeout=="function"?clearTimeout:null,ue=typeof setImmediate<"u"?setImmediate:null;function Q(z){for(var V=f(k);V!==null;){if(V.callback===null)d(k);else if(V.startTime<=z)d(k),V.sortIndex=V.expirationTime,s(b,V);else break;V=f(k)}}function we(z){if(ce=!1,Q(z),!Y)if(f(b)!==null)Y=!0,Pe||(Pe=!0,Qe());else{var V=f(k);V!==null&&b1(we,V.startTime-z)}}var Pe=!1,ie=-1,Ye=5,A1=-1;function _2(){return X?!0:!(h.unstable_now()-A1<Ye)}function q1(){if(X=!1,Pe){var z=h.unstable_now();A1=z;var V=!0;try{e:{Y=!1,ce&&(ce=!1,de(ie),ie=-1),$=!0;var G=B;try{t:{for(Q(z),j=f(b);j!==null&&!(j.expirationTime>z&&_2());){var fe=j.callback;if(typeof fe=="function"){j.callback=null,B=j.priorityLevel;var ge=fe(j.expirationTime<=z);if(z=h.unstable_now(),typeof ge=="function"){j.callback=ge,Q(z),V=!0;break t}j===f(b)&&d(b),Q(z)}else d(b);j=f(b)}if(j!==null)V=!0;else{var p=f(k);p!==null&&b1(we,p.startTime-z),V=!1}}break e}finally{j=null,B=G,$=!1}V=void 0}}finally{V?Qe():Pe=!1}}}var Qe;if(typeof ue=="function")Qe=function(){ue(q1)};else if(typeof MessageChannel<"u"){var Ct=new MessageChannel,B1=Ct.port2;Ct.port1.onmessage=q1,Qe=function(){B1.postMessage(null)}}else Qe=function(){F(q1,0)};function b1(z,V){ie=F(function(){z(h.unstable_now())},V)}h.unstable_IdlePriority=5,h.unstable_ImmediatePriority=1,h.unstable_LowPriority=4,h.unstable_NormalPriority=3,h.unstable_Profiling=null,h.unstable_UserBlockingPriority=2,h.unstable_cancelCallback=function(z){z.callback=null},h.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ye=0<z?Math.floor(1e3/z):5},h.unstable_getCurrentPriorityLevel=function(){return B},h.unstable_next=function(z){switch(B){case 1:case 2:case 3:var V=3;break;default:V=B}var G=B;B=V;try{return z()}finally{B=G}},h.unstable_requestPaint=function(){X=!0},h.unstable_runWithPriority=function(z,V){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var G=B;B=z;try{return V()}finally{B=G}},h.unstable_scheduleCallback=function(z,V,G){var fe=h.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?fe+G:fe):G=fe,z){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=G+ge,z={id:D++,callback:V,priorityLevel:z,startTime:G,expirationTime:ge,sortIndex:-1},G>fe?(z.sortIndex=G,s(k,z),f(b)===null&&z===f(k)&&(ce?(de(ie),ie=-1):ce=!0,b1(we,G-fe))):(z.sortIndex=ge,s(b,z),Y||$||(Y=!0,Pe||(Pe=!0,Qe()))),z},h.unstable_shouldYield=_2,h.unstable_wrapCallback=function(z){var V=B;return function(){var G=B;B=V;try{return z.apply(this,arguments)}finally{B=G}}}})(Ib)),Ib}var Yz;function Tj(){return Yz||(Yz=1,jb.exports=Ij()),jb.exports}var Tb={exports:{}},Ne={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qz;function Dj(){if(Qz)return Ne;Qz=1;var h=Ob();function s(b){var k="https://react.dev/errors/"+b;if(1<arguments.length){k+="?args[]="+encodeURIComponent(arguments[1]);for(var D=2;D<arguments.length;D++)k+="&args[]="+encodeURIComponent(arguments[D])}return"Minified React error #"+b+"; visit "+k+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var d={d:{f,r:function(){throw Error(s(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},x=Symbol.for("react.portal");function C(b,k,D){var j=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:x,key:j==null?null:""+j,children:b,containerInfo:k,implementation:D}}var H=h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function T(b,k){if(b==="font")return"";if(typeof k=="string")return k==="use-credentials"?k:""}return Ne.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,Ne.createPortal=function(b,k){var D=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!k||k.nodeType!==1&&k.nodeType!==9&&k.nodeType!==11)throw Error(s(299));return C(b,k,null,D)},Ne.flushSync=function(b){var k=H.T,D=d.p;try{if(H.T=null,d.p=2,b)return b()}finally{H.T=k,d.p=D,d.d.f()}},Ne.preconnect=function(b,k){typeof b=="string"&&(k?(k=k.crossOrigin,k=typeof k=="string"?k==="use-credentials"?k:"":void 0):k=null,d.d.C(b,k))},Ne.prefetchDNS=function(b){typeof b=="string"&&d.d.D(b)},Ne.preinit=function(b,k){if(typeof b=="string"&&k&&typeof k.as=="string"){var D=k.as,j=T(D,k.crossOrigin),B=typeof k.integrity=="string"?k.integrity:void 0,$=typeof k.fetchPriority=="string"?k.fetchPriority:void 0;D==="style"?d.d.S(b,typeof k.precedence=="string"?k.precedence:void 0,{crossOrigin:j,integrity:B,fetchPriority:$}):D==="script"&&d.d.X(b,{crossOrigin:j,integrity:B,fetchPriority:$,nonce:typeof k.nonce=="string"?k.nonce:void 0})}},Ne.preinitModule=function(b,k){if(typeof b=="string")if(typeof k=="object"&&k!==null){if(k.as==null||k.as==="script"){var D=T(k.as,k.crossOrigin);d.d.M(b,{crossOrigin:D,integrity:typeof k.integrity=="string"?k.integrity:void 0,nonce:typeof k.nonce=="string"?k.nonce:void 0})}}else k==null&&d.d.M(b)},Ne.preload=function(b,k){if(typeof b=="string"&&typeof k=="object"&&k!==null&&typeof k.as=="string"){var D=k.as,j=T(D,k.crossOrigin);d.d.L(b,D,{crossOrigin:j,integrity:typeof k.integrity=="string"?k.integrity:void 0,nonce:typeof k.nonce=="string"?k.nonce:void 0,type:typeof k.type=="string"?k.type:void 0,fetchPriority:typeof k.fetchPriority=="string"?k.fetchPriority:void 0,referrerPolicy:typeof k.referrerPolicy=="string"?k.referrerPolicy:void 0,imageSrcSet:typeof k.imageSrcSet=="string"?k.imageSrcSet:void 0,imageSizes:typeof k.imageSizes=="string"?k.imageSizes:void 0,media:typeof k.media=="string"?k.media:void 0})}},Ne.preloadModule=function(b,k){if(typeof b=="string")if(k){var D=T(k.as,k.crossOrigin);d.d.m(b,{as:typeof k.as=="string"&&k.as!=="script"?k.as:void 0,crossOrigin:D,integrity:typeof k.integrity=="string"?k.integrity:void 0})}else d.d.m(b)},Ne.requestFormReset=function(b){d.d.r(b)},Ne.unstable_batchedUpdates=function(b,k){return b(k)},Ne.useFormState=function(b,k,D){return H.H.useFormState(b,k,D)},Ne.useFormStatus=function(){return H.H.useHostTransitionStatus()},Ne.version="19.2.4",Ne}var Kz;function pA(){if(Kz)return Tb.exports;Kz=1;function h(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(h)}catch(s){console.error(s)}}return h(),Tb.exports=Dj(),Tb.exports}/**
 * @license React
 ...
 *
 * @license MIT
 */function xc(){return xc=Object.assign?Object.assign.bind():function(h){for(var s=1;s<arguments.length;s++){var f=arguments[s];for(var d in f)Object.prototype.hasOwnProperty.call(f,d)&&(h[d]=f[d])}return h},xc.apply(this,arguments)}var O2;(function(h){h.Pop="POP",h.Push="PUSH",h.Replace="REPLACE"})(O2||(O2={}));const $z="popstate";function Rj(h){h===void 0&&(h={});function s(x,C){let{pathname:H="/",search:T="",hash:b=""}=Lc(x.location.hash.substr(1));return!H.startsWith("/")&&!H.startsWith(".")&&(H="/"+H),Vb("",{pathname:H,search:T,hash:b},C.state&&C.state.usr||null,C.state&&C.state.key||"default")}function f(x,C){let H=x.document.querySelector("base"),T="";if(H&&H.getAttribute("href")){let b=x.location.href,k=b.indexOf("#");T=k===-1?b:b.slice(0,k)}return T+"#"+(typeof C=="string"?C:nx(C))}function d(x,C){kA(x.pathname.charAt(0)==="/","relative pathnames are not supported in hash history.push("+JSON.stringify(C)+")")}return Ej(s,f,d,h)}function z1(h,s){if(h===!1||h===null||typeof h>"u")throw new Error(s)}function kA(h,s){if(!h){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function Uj(){return Math.random().toString(36).substr(2,8)}function eA(h,s){return{usr:h.state,key:h.key,idx:s}}function Vb(h,s,f,d){return f===void 0&&(f=null),xc({pathname:typeof h=="string"?h:h.pathname,search:"",hash:""},typeof s=="string"?Lc(s):s,{state:f,key:s&&s.key||d||Uj()})}function nx(h){let{pathname:s="/",search:f="",hash:d=""}=h;return f&&f!=="?"&&(s+=f.charAt(0)==="?"?f:"?"+f),d&&d!=="#"&&(s+=d.charAt(0)==="#"?d:"#"+d),s}function Lc(h){let s={};if(h){let f=h.indexOf("#");f>=0&&(s.hash=h.substr(f),h=h.substr(0,f));let d=h.indexOf("?");d>=0&&(s.search=h.substr(d),h=h.substr(0,d)),h&&(s.pathname=h)}return s}function Ej(h,s,f,d){d===void 0&&(d={});let{window:x=document.defaultView,v5Compat:C=!1}=d,H=x.history,T=O2.Pop,b=null,k=D();k==null&&(k=0,H.replaceState(xc({},H.state,{idx:k}),""));function D(){return(H.state||{idx:null}).idx}function j(){T=O2.Pop;let X=D(),F=X==null?null:X-k;k=X,b&&b({action:T,location:ce.location,delta:F})}function B(X,F){T=O2.Push;let de=Vb(ce.location,X,F);f&&f(de,X),k=D()+1;let ue=eA(de,k),Q=ce.createHref(de);try{H.pushState(ue,"",Q)}catch(we){if(we instanceof DOMException&&we.name==="DataCloneError")throw we;x.location.assign(Q)}C&&b&&b({action:T,location:ce.location,delta:1})}function $(X,F){T=O2.Replace;let de=Vb(ce.location,X,F);f&&f(de,X),k=D();let ue=eA(de,k),Q=ce.createHref(de);H.replaceState(ue,"",Q),C&&b&&b({action:T,location:ce.location,delta:0})}function Y(X){let F=x.location.origin!=="null"?x.location.origin:x.location.href,de=typeof X=="string"?X:nx(X);return de=de.replace(/ $/,"%20"),z1(F,"No window.location.(origin|href) available to create URL for href: "+de),new URL(de,F)}let ce={get action(){return T},get location(){return h(x,H)},listen(X){if(b)throw new Error("A history only accepts one active listener");return x.addEventListener($z,j),b=X,()=>{x.removeEventListener($z,j),b=null}},createHref(X){return s(x,X)},createURL:Y,encodeLocation(X){let F=Y(X);return{pathname:F.pathname,search:F.search,hash:F.hash}},push:B,replace:$,go(X){return H.go(X)}};return ce}var tA;(function(h){h.data="data",h.deferred="deferred",h.redirect="redirect",h.error="error"})(tA||(tA={}));function fA(h,s){if(s==="/")return h;if(!h.toLowerCase().startsWith(s.toLowerCase()))return null;let f=s.endsWith("/")?s.length-1:s.length,d=h.charAt(f);return d&&d!=="/"?null:h.slice(f)||"/"}const Zj=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Fj=h=>Zj.test(h);function Nj(h,s){s===void 0&&(s="/");let{pathname:f,search:d="",hash:x=""}=typeof h=="string"?Lc(h):h,C;if(f)if(Fj(f))C=f;else{if(f.includes("//")){let H=f;f=f.replace(/\/\/+/g,"/"),kA(!1,"Pathnames cannot have embedded double slashes - normalizing "+(H+" -> "+f))}f.startsWith("/")?C=aA(f.substring(1),"/"):C=aA(f,s)}else C=s;return{pathname:C,search:Xj(d),hash:Pj(x)}}function aA(h,s){let f=s.replace(/\/+$/,"").split("/");return h.split("/").forEach(x=>{x===".."?f.length>1&&f.pop():x!=="."&&f.push(x)}),f.length>1?f.join("/"):"/"}function Db(h,s,f,d){return"Cannot include a '"+h+"' character in a manually specified "+("`to."+s+"` field ["+JSON.stringify(d)+"].  Please separate it out to the ")+("`to."+f+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Gj(h){return h.filter((s,f)=>f===0||s.route.path&&s.route.path.length>0)}function MA(h,s){let f=Gj(h);return s?f.map((d,x)=>x===f.length-1?d.pathname:d.pathnameBase):f.map(d=>d.pathnameBase)}function vA(h,s,f,d){d===void 0&&(d=!1);let x;typeof h=="string"?x=Lc(h):(x=xc({},h),z1(!x.pathname||!x.pathname.includes("?"),Db("?","pathname","search",x)),z1(!x.pathname||!x.pathname.includes("#"),Db("#","pathname","hash",x)),z1(!x.search||!x.search.includes("#"),Db("#","search","hash",x)));let C=h===""||x.pathname==="",H=C?"/":x.pathname,T;if(H==null)T=f;else{let j=s.length-1;if(!d&&H.startsWith("..")){let B=H.split("/");for(;B[0]==="..";)B.shift(),j-=1;x.pathname=B.join("/")}T=j>=0?s[j]:"/"}let b=Nj(x,T),k=H&&H!=="/"&&H.endsWith("/"),D=(C||H===".")&&f.endsWith("/");return!b.pathname.endsWith("/")&&(k||D)&&(b.pathname+="/"),b}const mA=h=>h.join("/").replace(/\/\/+/g,"/"),Xj=h=>!h||h==="?"?"":h.startsWith("?")?h:"?"+h,Pj=h=>!h||h==="#"?"":h.startsWith("#")?h:"#"+h,gA=["post","put","patch","delete"];new Set(gA);const Yj=["get",...gA];new Set(Yj);/**
 ...
 *
 * @license MIT
 */function ix(){return ix=Object.assign?Object.assign.bind():function(h){for(var s=1;s<arguments.length;s++){var f=arguments[s];for(var d in f)Object.prototype.hasOwnProperty.call(f,d)&&(h[d]=f[d])}return h},ix.apply(this,arguments)}const xA=E.createContext(null),Sa=E.createContext(null),_b=E.createContext(null),ox=E.createContext({outlet:null,matches:[],isDataRoute:!1});function Qj(h,s){let{relative:f}=s===void 0?{}:s;yx()||z1(!1);let{basename:d,navigator:x}=E.useContext(Sa),{hash:C,pathname:H,search:T}=bA(h,{relative:f}),b=H;return d!=="/"&&(b=H==="/"?d:mA([d,H])),x.createHref({pathname:b,search:T,hash:C})}function yx(){return E.useContext(_b)!=null}function Rb(){return yx()||z1(!1),E.useContext(_b).location}function LA(h){E.useContext(Sa).static||E.useLayoutEffect(h)}function Kj(){let{isDataRoute:h}=E.useContext(ox);return h?tI():Jj()}function Jj(){yx()||z1(!1);let h=E.useContext(xA),{basename:s,future:f,navigator:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:C}=Rb(),H=JSON.stringify(MA(x,f.v7_relativeSplatPath)),T=E.useRef(!1);return LA(()=>{T.current=!0}),E.useCallback(function(k,D){if(D===void 0&&(D={}),!T.current)return;if(typeof k=="number"){d.go(k);return}let j=vA(k,JSON.parse(H),C,D.relative==="path");h==null&&s!=="/"&&(j.pathname=j.pathname==="/"?s:mA([s,j.pathname])),(D.replace?d.replace:d.push)(j,D.state,D)},[s,d,H,C,h])}function bA(h,s){let{relative:f}=s===void 0?{}:s,{future:d}=E.useContext(Sa),{matches:x}=E.useContext(ox),{pathname:C}=Rb(),H=JSON.stringify(MA(x,d.v7_relativeSplatPath));return E.useMemo(()=>vA(h,JSON.parse(H),C,f==="path"),[h,H,C,f])}var SA=(function(h){return h.UseBlocker="useBlocker",h.UseRevalidator="useRevalidator",h.UseNavigateStable="useNavigate",h})(SA||{}),wA=(function(h){return h.UseBlocker="useBlocker",h.UseLoaderData="useLoaderData",h.UseActionData="useActionData",h.UseRouteError="useRouteError",h.UseNavigation="useNavigation",h.UseRouteLoaderData="useRouteLoaderData",h.UseMatches="useMatches",h.UseRevalidator="useRevalidator",h.UseNavigateStable="useNavigate",h.UseRouteId="useRouteId",h})(wA||{});function Wj(h){let s=E.useContext(xA);return s||z1(!1),s}function $j(h){let s=E.useContext(ox);return s||z1(!1),s}function eI(h){let s=$j(),f=s.matches[s.matches.length-1];return f.route.id||z1(!1),f.route.id}function tI(){let{router:h}=Wj(SA.UseNavigateStable),s=eI(wA.UseNavigateStable),f=E.useRef(!1);return LA(()=>{f.current=!0}),E.useCallback(function(x,C){C===void 0&&(C={}),f.current&&(typeof x=="number"?h.navigate(x):h.navigate(x,ix({fromRouteId:s},C)))},[h,s])}function aI(h,s){h==null||h.v7_startTransition,h==null||h.v7_relativeSplatPath}function cI(h){let{basename:s="/",children:f=null,location:d,navigationType:x=O2.Pop,navigator:C,static:H=!1,future:T}=h;yx()&&z1(!1);let b=s.replace(/^\/*/,"/"),k=E.useMemo(()=>({basename:b,navigator:C,static:H,future:ix({v7_relativeSplatPath:!1},T)}),[b,T,C,H]);typeof d=="string"&&(d=Lc(d));let{pathname:D="/",search:j="",hash:B="",state:$=null,key:Y="default"}=d,ce=E.useMemo(()=>{let X=fA(D,b);return X==null?null:{location:{pathname:X,search:j,hash:B,state:$,key:Y},navigationType:x}},[b,D,j,B,$,Y,x]);return ce==null?null:E.createElement(Sa.Provider,{value:k},E.createElement(_b.Provider,{children:f,value:ce}))}new Promise(()=>{});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const LI=h=>h.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),l=(h,s)=>{const f=E.forwardRef(({color:d="currentColor",size:x=24,strokeWidth:C=2,absoluteStrokeWidth:H,className:T="",children:b,...k},D)=>E.createElement("svg",{ref:D,...xI,width:x,height:x,stroke:d,strokeWidth:H?Number(C)*24/Number(x):C,className:["lucide",`lucide-${LI(h)}`,T].join(" "),...k},[...s.map(([j,B])=>E.createElement(j,B)),...Array.isArray(b)?b:[b]]));return f.displayName=`${h}`,f};/**
 * @license lucide-react v0.300.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
